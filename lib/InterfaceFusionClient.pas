...
type
  ...
  ['{0F952F88-2741-43C2-B8CF-BA593A42F8B0}']
    ...
    /// </summary>
    function ConnectAsync(ATask: ITask): Boolean;

    /// <summary>
    /// Disconnects and releases resources
    /// </summary>
    procedure DisconnectAsync(ATask: ITask);
    ...
    function SendAsync(ARequestMessage: TMessagePayload): TSaleToPOIMessage; overload;
