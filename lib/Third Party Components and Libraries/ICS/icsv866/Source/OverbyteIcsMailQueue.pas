...
const
    MailQuCopyRight : String = ' TIcsMailQueue (c) 2021 V8.66 ';
...
begin
    ...
    FileName := IncludeTrailingPathDelimiter (FMailQuDir) + 'spool\item' + PadIntZero (item, 8) + '.eml' ;
        ...
        try
            ...
            begin
                ...
                if NOT GSSLStaticLinked then    { V8.66 }
                    DoLogEvent (MLogLevelInfo, 'SSL/TLS Version: ' + OpenSslVersion + ' - ' + OpenSslPlatForm + ': ' + GLIBEAY_DLL_FileName)
                else
                    DoLogEvent (MLogLevelInfo, 'SSL/TLS Static Linked Version: ' + OpenSslVersion + ' - ' + OpenSslPlatForm) ;
            end;
        except
