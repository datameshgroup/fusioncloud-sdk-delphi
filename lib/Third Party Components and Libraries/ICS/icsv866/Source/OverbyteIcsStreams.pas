...
Legal issues: Copyright (C) 2005-2020 by Arno Garrels, Berlin, Germany,
...
Aug 14, 2020 V8.65 Corrected NewSize: Integer to LongInt to match base class.
...
{$ENDIF USE_OLD_BUFFERED_FILESTREAM}
    ...
    protected
        procedure SetSize(const NewSize: Int64); override;
    public
        constructor Create(AStream : TStream; BufferSize : LongInt = 256 ; Style: TTextLineBreakStyle = tlbsCRLF);     { V8.65 was Integer }
        destructor Destroy; override;
        procedure Flush;
    ...
    protected
        ...
        procedure   SetSize(NewSize: LongInt); override;      { V8.65 was Integer }
        procedure   SetSize(const NewSize: Int64); override;
    ...
    public
        ...
        constructor Create(Stream     : TStream;
                           BufferSize : LongInt;       { V8.65 was Integer }
        ...
        function    Read(var Buffer; Count: LongInt): LongInt; override;                 { V8.65 was Integer }
        function    Seek(Offset: LongInt; Origin: Word): LongInt; override;              { V8.65 was Integer }
        function    Seek(const Offset: Int64; Origin: TSeekOrigin): Int64; override;
        function    Write(const Buffer; Count: LongInt): LongInt; override;              { V8.65 was Integer }
    ...
    public
        constructor Create(Stream     : TStream;
                           BufferSize : LongInt = DEFAULT_BUFSIZE;      { V8.65 was Integer }
    ...
    public
        ...
        constructor Create(const FileName : String;
                           Mode           : Word;
                           Rights         : Cardinal;
                           BufferSize     : LongInt); override;                   { V8.65x was Integer }
        ...
        constructor Create(const FileName : WideString;
                           Mode           : Word;
                           Rights         : Cardinal;
                           BufferSize     : LongInt); override;                   { V8.65 was Integer }
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TIcsBufferedFileStream.SetSize(NewSize: LongInt);   { V8.65 was integer }
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMultiPartFileReader.Read(var Buffer; Count: LongInt): Longint;       { V8.64 was Integer }
var
    ToRead    : LongInt;          { V8.64 was Integer }
    FooterPos : Integer;
    POutBuf   : PAnsiChar;
begin
    Result := 0;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMultiPartFileReader.Write(const Buffer; Count: LongInt): Longint;     { V8.64 was Integer }
begin
    Result := 0;  // Read only!
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMultiPartFileReader.Seek(Offset: LongInt; Origin: Word): Longint;   { V8.65 was Integer }
begin
    Result := Seek(Int64(Offset), TSeekOrigin(Origin));
end;
...
constructor TTextStream.Create(
    AStream    : TStream;
    BufferSize : LongInt;                                { V8.64 was Integer }
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TTextStream.Read(var Buffer; Count: LongInt): Longint;     { V8.64 was Integer }
begin
    SetMode(tsmRead);
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TTextStream.Write(const Buffer; Count: LongInt): Longint;    { V8.64 was Integer }
begin
    SetMode(tsmWrite);
...
constructor TIcsBufferedStream.Create(Stream: TStream; BufferSize: Longint; OwnsStream: Boolean = FALSE);
begin
    inherited Create;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsBufferedStream.Create(const FileName: String; Mode: Word; BufferSize: LongInt);     { V8.65 was Integer }
begin
    Create(FileName, Mode, FileAccessRights, BufferSize);
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsBufferedStream.Create(const FileName: WideString; Mode: Word; BufferSize: LongInt); { V8.65 was Integer }
begin
    Create(FileName, Mode, FileAccessRights, BufferSize);
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsBufferedStream.Create(const FileName: String; Mode: Word; Rights: Cardinal; BufferSize: LongInt);  { V8.65 was Integer }
begin
    inherited Create;
    { Even in mode fmOpenWrite we need to read from file as well }
    CheckAddFileModeReadWrite(Mode);
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TIcsBufferedStream.Read(var Buffer; Count: LongInt): Longint;   { V8.64 was Integer }
var
    BufPos   : Integer;
    SrcIndex : Integer;
    Remaining: Integer;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TIcsBufferedStream.Seek(const Offset: Int64; Origin: TSeekOrigin): Int64;
var
    NewPos: Int64;
begin
    case Origin of
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TIcsBufferedStream.Seek(Offset: LongInt; Origin: Word): LongInt;   { V8.65 was Integer }
begin
    Result := Seek(Int64(Offset), TSeekOrigin(Origin));
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TIcsBufferedStream.SetSize(NewSize: LongInt);   { V8.65 was integer }
begin
    SetSize(Int64(NewSize));
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TIcsBufferedStream.Write(const Buffer; Count: LongInt): Longint;    { V8.64 was Integer }
var
    DestPos   : Integer;
    SrcIndex  : Integer;
    Remaining : Integer;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamReader.Create(Stream: TStream; BufferSize: LongInt = DEFAULT_BUFSIZE; OwnsStream: Boolean = FALSE); { V8.65 was Integer }
begin
    Create(Stream, False);
end;
...
constructor TIcsStreamReader.Create(Stream: TStream; DetectBOM: Boolean = FALSE;
  CodePage: LongWord = CP_ACP; OwnsStream: Boolean = FALSE; BufferSize: LongInt = DEFAULT_BUFSIZE);  { V8.65 was Integer }
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamReader.Create(const FileName: String; Mode: Word; BufferSize: LongInt = DEFAULT_BUFSIZE);  { V8.65 was Integer }
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamReader.Create(const FileName: String; DetectBOM: Boolean = TRUE;
                        CodePage: LongWord = CP_ACP; BufferSize: LongInt = DEFAULT_BUFSIZE);  { V8.65 was Integer }
begin
    FDetectBOM := DetectBOM;
    FCodePage  := CodePage;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamReader.Create(const FileName: WideString; DetectBOM: Boolean = TRUE; CodePage:
                                        LongWord = CP_ACP; BufferSize: LongInt = DEFAULT_BUFSIZE);  { V8.65 was Integer }
begin
    FDetectBOM := DetectBOM;
    FCodePage  := CodePage;
    inherited Create(FileName, fmOpenRead or fmShareDenyWrite, FileAccessRights, BufferSize);
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamWriter.Create(Stream: TStream; BufferSize: LongInt = DEFAULT_BUFSIZE; OwnsStream: Boolean = FALSE);  { V8.65 was Integer }
begin
...
constructor TIcsStreamWriter.Create(Stream: TStream; Append: Boolean = TRUE;
                      ...
                      OwnsStream: Boolean = FALSE; BufferSize: LongInt = DEFAULT_BUFSIZE);  { V8.65 was Integer }
begin
    FCodePage  := CodePage;
    inherited Create(Stream, BufferSize, OwnsStream);
    if DetectBom then
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
constructor TIcsStreamWriter.Create(const FileName: String; Mode: Word; Rights: Cardinal; BufferSize: LongInt);  { V8.65 was Integer }
begin
    FCodePage := CP_ACP;
