...
9 Apr 2019  - V8.61 - Base component now has more response headers, don't need
                 to search for them.
17 Dec 2020 - V8.65 - Builds without SSL again.
...
const
    HttpMultiCopyRight : String = ' TIcsHttpMultiW (c) 2021 V8.66 ';
type
                ...
                begin
                    ...
                    // found an Anchor tag, look for link name
                        ...
                        // check if link is file we want to download or another page we want to search      
                            info := LowerCase (IcsExtractUNIXNameW (dochref)) ;  // convert slashes to backslash
    ...
    // start real HTTP downloading
        ...
        begin
            ...
            begin
                ...
                begin
                    duration := IcsGetTickCount - fstarttick ;
                    doCopyEvent (LogLevelInfo, 'Can Not Access URL: ' + curURL + ', ' +
                                                        myerror + ' (' + IntToStr (statcode) + ')') ;   // 19 Oct 2015
                    doCopyEvent (LogLevelDelimFile, curURL + '|' + fnametar + '|0|0|1|Download Failed: ' +
