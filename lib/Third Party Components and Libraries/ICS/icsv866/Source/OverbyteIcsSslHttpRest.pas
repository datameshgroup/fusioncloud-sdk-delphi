...
URL encoded or Json, including arrays.  Many options for varied REST schemes.
...
const
    THttpRestVersion = 866;
    CopyRight : String = ' TSslHttpRest (c) 2021 F. Piette V8.66 ';
    DefMaxBodySize = 100000000; { max memory/string size 100Mbyte }
...
{ property and state types }
  ...
  TRParamType = (RPTypeStr, RPTypeInt, RPTypeDate, RPTypeFloat, RPTypeBool, RPTypeObj, RPTypeArray); { V8.65 }

const
  RParamTypeLits: array[TRParamType] of string =
        ('RPTypeStr','RPTypeInt','RPTypeDate','RPTypeFloat','RPTypeBool','RPTypeObj','RPTypeArray');  { V8.65 }
                ...
                if PN <> '' then begin
                 ...
                 { V8.65 see if building Json array from StringList }
                  ...
                  { V8.65 data types that don't need quotes }
                    if Items[I].RParamType in [RPTypeInt, RPTypeFloat, RPTypeBool, RPTypeObj] then
                        JFlag := True;
        ...
        if (FAccToken = '') or (FAccExpireDT < Now) then begin
            ...
            if NOT Result then begin
              ...
              // need to wait for the user to fill in the login using a brower windows
                if FLoginTimeout < 5 then FLoginTimeout := 30;
    ...
    try
        ...
        // see if ping reached correct host, needs a high TTL
            ...
            begin
                ...
                begin
                    AliveRestProg(Self, loProtSpecErr, 'Ping Did Not Reach Host ' + PingHostName + ', Request IP ' +
