...
Legal issues: Copyright (C) 2007-2021 by François PIETTE
...
Note internal certificate bundle includes some expired certiticates
to avoid fatal errors on some old sites, not sure if should remove or not?
...
PEM bundle file sslRootCACertsBundle.pem built by Magenta Systems Ltd at 2020-06-19T17:21:37
...
The built-in bundle (constants below) is 35 certificates covering all major
...
{ 
Issued to (CN): AddTrust External CA Root, (O): AddTrust AB, (OU): AddTrust External TTP Network
Issuer: Self Signed
Expires: 2020-05-30T10:48:38, Signature: sha1WithRSAEncryption
Valid From: 2000-05-30T10:48:38, Serial Number: 01
...
{ 
Issued to (CN): Deutsche Telekom Root CA 2, (O): Deutsche Telekom AG, (OU): T-TeleSec Trust Center
Issuer: Self Signed
Expires: 2019-07-09T23:59:00, Signature: sha1WithRSAEncryption
Valid From: 1999-07-09T12:11:00, Serial Number: 26
Fingerprint (sha256): b6191a50d0c3977f7da99bcdaac86a227daeb9679ec70ba3b0c9d92271c170d3
Public Key: RSA Key Encryption 2048 bits, 112 security bits }
...
{ 
Issued to (CN): GeoTrust Global CA, (O): GeoTrust Inc.
Issuer: Self Signed
Expires: 2022-05-21T04:00:00, Signature: sha1WithRSAEncryption
Valid From: 2002-05-21T04:00:00, Serial Number: 023456
Fingerprint (sha256): ff856a2d251dcd88d36656f450126798cfabaade40799c722de4d2b5db36a73a
Public Key: RSA Key Encryption 2048 bits, 112 security bits }
...
{ 
Issued to (CN): Thawte Premium Server CA, (O): Thawte Consulting cc, (OU): Certification Services Division
Issuer: Self Signed
Expires: 2020-12-31T23:59:59, Signature: md5WithRSAEncryption
Valid From: 1996-08-01T00:00:00, Serial Number: 01
Fingerprint (sha256): ab7036365c7154aa29c2c29f5d4191163b162a2225011357d56d07ffa7bc1f72
Public Key: RSA Key Encryption 1024 bits, 80 security bits }
...
{ 
Issued to (CN): VeriSign Class 3 Public Primary Certification Authority - G5, (O): VeriSign, Inc., (OU): VeriSign Trust Network, (c) 2006 VeriSign, Inc. - For authorized use only
Issuer: Self Signed
Expires: 2036-07-16T23:59:59, Signature: sha1WithRSAEncryption
Valid From: 2006-11-08T00:00:00, Serial Number: 18dad19e267de8bb4a2158cdcc6b3b4a
...
{
Issued to (CN): thawte Primary Root CA, (O): thawte, Inc., (OU): Certification Services Division, (c) 2006 thawte, Inc. - For authorized use only
Issuer: Self Signed
Expires: 2036-07-16T23:59:59, Signature: sha1WithRSAEncryption
Valid From: 2006-11-17T00:00:00, Serial Number: 344ed55720d5edec49f42fce37db2b6d
Fingerprint (sha256): 8d722f81a9c113c0791df136a2966db26c950a971db46b4199f4ea54b78bfb9f
Public Key: RSA Key Encryption 2048 bits, 112 security bits }
...
begin
    ...
    try
      ...
      { now save them to file - no password unless PKX }
        ...
        if PW <> '' then PrivKeyType := PrivKeyEncTripleDES;
