...
const
  FtpCliVersion      = 866;
  CopyRight : String = ' TFtpCliW (c) 1996-2021 F. Piette V8.66 ';
  FtpClientId : String = 'ICS FTP Client V8.66 Wide';   { V2.113 sent with CLNT command  }
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TCustomFtpCliW.AbortComponent; { V7.15 }
begin
    try
        AbortAsync;
    except
    ...
    try
        ...
        if FResumeAt <= 0 then begin
            ...
            if not Assigned(FLocalStream) and not FStreamFlag then begin  { V2.112 }
                ...
                { new position.                                                    }
                NewPos := IcsGetFileSizeW(FLocalFileName);                 { V8.60 }
