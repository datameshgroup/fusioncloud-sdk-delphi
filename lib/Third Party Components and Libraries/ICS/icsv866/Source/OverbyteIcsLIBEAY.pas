...
const
    IcsLIBEAYVersion   = 866;
    CopyRight : String = ' IcsLIBEAY (c) 2003-2021 F. Piette V8.66 ';
...
// EVP_PKEY_ only
  ...
  { point_conversion_form_t Enum for the point conversion form as defined in X9.62 (ECDSA) for the encoding of a elliptic curve point (x,y) }
    ...
    OPENSSL_VERSION_       = 0;        { V8.66 renamed to avoid function conflict }
    OPENSSL_CFLAGS         = 1;
    OPENSSL_BUILT_ON       = 2;
    OPENSSL_PLATFORM       = 3;
    OPENSSL_DIR            = 4;
...
const
    ...
    BN_bin2bn :                              function(bins: PAnsiChar; lens : integer; updateNum : PBIGNUM = nil ): PBIGNUM; cdecl = nil;  { V8.64 }
    ...
    ECDSA_sign :                             function(xtype: integer; dgst: PAnsiChar; dgst_len: integer; sig: PAnsiChar; signlen: integer; eckey: PEC_KEY): integer; cdecl = Nil;               { V8.40 }
    ECDSA_sign_ex :                          function(xtype: integer; dgst: PAnsiChar; dgst_len: integer; sig: PAnsiChar; signlen: integer; kinv: PBIGNUM; rp: PBIGNUM; eckey: PEC_KEY): integer; cdecl = Nil;  { V8.40 }
    ...
    EVP_MD_type :                            function(md: PEVP_MD): Integer; cdecl = Nil;                       { V8.40 }
    EVP_MD_pkey_type :                       function(md: PEVP_MD): Integer; cdecl = Nil;                       { V8.40 }
    EVP_MD_size :                            function(md: PEVP_MD): Integer; cdecl = Nil;                       { V8.40 }
    EVP_MD_block_size :                      function(md: PEVP_MD): Integer; cdecl = Nil;                       { V8.40 }
    EVP_MD_flags :                           function(md: PEVP_MD): Integer; cdecl = Nil;                       { V8.40 }
    ...
    EVP_PKEY_base_id :                       function(Pkey: PEVP_PKEY): Integer; cdecl = nil;                       { V8.40 }
    EVP_PKEY_bits :                          function(Pkey: PEVP_PKEY): Integer; cdecl = nil;//AG
    ...
    EVP_PKEY_id :                            function(Pkey: PEVP_PKEY): Integer; cdecl = nil;                               { V8.64 }
    ...
    EVP_PKEY_security_bits :                 function(Pkey: PEVP_PKEY): Integer; cdecl = nil;                              { V8.51 }
    EVP_PKEY_set_alias_type :                function(Pkey: PEVP_PKEY; ptype: Integer): Integer; cdecl = nil;                                          { V8.64 }
    ...
    EVP_PKEY_size :                          function(Pkey: PEVP_PKEY): Integer; cdecl = nil;//AG
...
const
    GLIBEAYImports1: array[0..597] of TOSSLImports = (
    ...
    (F: @@EVP_MD_block_size ;       N: 'EVP_MD_block_size';     MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    (F: @@EVP_MD_flags ;            N: 'EVP_MD_flags';          MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    (F: @@EVP_MD_pkey_type ;        N: 'EVP_MD_pkey_type';      MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    (F: @@EVP_MD_size ;             N: 'EVP_MD_size';           MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    (F: @@EVP_MD_type ;             N: 'EVP_MD_type';           MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    ...
    (F: @@EVP_PKEY_base_id;         N: 'EVP_PKEY_base_id';   MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),   { V8.40 }
    (F: @@EVP_PKEY_bits;            N: 'EVP_PKEY_bits';      MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),
    ...
    (F: @@EVP_PKEY_id;              N: 'EVP_PKEY_id';            MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),  { V8.64 }
    ...
    (F: @@EVP_PKEY_security_bits;   N: 'EVP_PKEY_security_bits';   MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),    { V8.51 }
    ...
    (F: @@EVP_PKEY_size;            N: 'EVP_PKEY_size';     MI: OSSL_VER_MIN; MX: OSSL_VER_MAX),
...
{ V8.65 try and load OpenSSL 3.0.x first, then 1.1.x, then 1.0.x }
    if (NOT GSSLEAY_DLL_IgnoreNew) and (MAX_OSSL_VER >= OSSL_VER_3000D) then begin  { V8.65 skip 3.0 for IgnoreNew }
    ...
    if GLIBEAY_DLL_Handle > 32 then begin
        ...
        if @OpenSSL_version_num = nil then begin
            ...
            raise EIcsLIBEAYException.Create('Failed to load OpenSSL file ' + GLIBEAY_DLL_FileName);   {V8.65 better exception }
        end;
    end
