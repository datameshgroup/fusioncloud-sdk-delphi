...
Dec 4, 2020  V8.65 Add five more header fields to TMimeDecodeW in unicode,
                     and all the unicode headers to TMimeDecodeEx.
...
const
    MimeDecodeVersion  = 865;
    CopyRight : String = ' TMimeDecode (c) 1998-2020 Francois Piette V8.65';
...
type
    ...
    private
        ...
        function GetDateW: UnicodeString;
        function GetReturnPathW: UnicodeString;
        function GetContentTypeW: UnicodeString;
        function GetEncodingW: UnicodeString;
        function GetCharsetW: UnicodeString;
    protected
    ...
    public
        ...
        property DateW            : UnicodeString    read  GetDateW;           { V8.65 }
        property ReturnPathW      : UnicodeString    read  GetReturnPathW;     { V8.65 }
        property ContentTypeW     : UnicodeString    read  GetContentTypeW;    { V8.65 }
        property EncodingW        : UnicodeString    read  GetEncodingW;       { V8.65 }
        property CharsetW         : UnicodeString    read  GetCharsetW;        { V8.65 }
    end;
...
{ V7.11 Decode file or stream into MIME Part Information records }
   TMimeDecodeEx = class(TComponent)
      ...
      published
        ...
        property FromW           : UnicodeString    read  GetFromW;            { V8.65 }
        property DestW           : UnicodeString    read  GetDestW;            { V8.65 }
        property CcW             : UnicodeString    read  GetCcW;              { V8.65 }
        property SubjectW        : UnicodeString    read  GetSubjectW;         { V8.65 }
        property FileNameW       : UnicodeString    read  GetFileNameW;        { V8.65 }
        property PartNameW       : UnicodeString    read  GetPartNameW;        { V8.65 }
        property PartFileNameW   : UnicodeString    read  GetPartFileNameW;    { V8.65 }
        property DateW           : UnicodeString    read  GetDateW;            { V8.65 }
        property ReturnPathW     : UnicodeString    read  GetReturnPathW;      { V8.65 }
        property ContentTypeW    : UnicodeString    read  GetContentTypeW;     { V8.65 }
        property EncodingW       : UnicodeString    read  GetEncodingW;        { V8.65 }
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetCcW: UnicodeString;                                  { V8.65 }
begin
    Result := FDecodeW.CcW;
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetDestW: UnicodeString;                                { V8.65 }
begin
    Result := FDecodeW.DestW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetFileNameW: UnicodeString;                            { V8.65 }
begin
    Result := FDecodeW.FileNameW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetFromW: UnicodeString;                                { V8.65 }
begin
    Result := FDecodeW.FromW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetPartFileNameW: UnicodeString;                        { V8.65 }
begin
    Result := FDecodeW.PartFileNameW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetPartNameW: UnicodeString;                            { V8.65 }
begin
    Result := FDecodeW.PartNameW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetSubjectW: UnicodeString;                             { V8.65 }
begin
    Result := FDecodeW.SubjectW;
end;

{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetDateW: UnicodeString;                                 { V8.65 }
begin
    Result := FDecodeW.DateW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetReturnPathW: UnicodeString;                           { V8.65 }
begin
    Result := FDecodeW.ReturnPathW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetContentTypeW: UnicodeString;                          { V8.65 }
begin
    Result := FDecodeW.ContentTypeW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetEncodingW: UnicodeString;                             { V8.65 }
begin
    Result := FDecodeW.EncodingW;
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeEx.GetCharsetW: UnicodeString;                              { V8.65 }
begin
    Result := FDecodeW.CharsetW;
end;
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function IsCrLf1Char(Ch : AnsiChar) : Boolean;
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeW.GetDateW: UnicodeString;                                 { V8.65 }
begin
    Result := DecodeMimeInlineValue(FDate);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeW.GetReturnPathW: UnicodeString;                           { V8.65 }
begin
    Result := DecodeMimeInlineValue(FReturnPath);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeW.GetContentTypeW: UnicodeString;                          { V8.65 }
begin
    Result := DecodeMimeInlineValue(FContentType);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeW.GetEncodingW: UnicodeString;                             { V8.65 }
begin
    Result := DecodeMimeInlineValue(FEncoding);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TMimeDecodeW.GetCharsetW: UnicodeString;                              { V8.65 }
begin
    Result := DecodeMimeInlineValue(FCharset);
end;
