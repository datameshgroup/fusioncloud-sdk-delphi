...
function deflateBound(var strm: z_stream; sourceLen: Integer): Integer;
...
function compress(dest: PAnsiChar; var destLen: Integer;
                  const source: PAnsiChar; sourceLen: Integer): Integer;
function compress2(dest: PAnsiChar; var destLen: Integer;
                  const source: PAnsiChar; sourceLen: Integer;
                  level: Integer): Integer;
function compressBound(sourceLen: Integer): Integer;
function uncompress(dest: PAnsiChar; var destLen: Integer;
                    const source: PAnsiChar; sourceLen: Integer): Integer;

(* checksum functions *)
function adler32(adler: Integer; const buf: PAnsiChar; len: Integer): Integer;
function crc32(crc: Integer; const buf: PAnsiChar; len: Integer): Integer;
