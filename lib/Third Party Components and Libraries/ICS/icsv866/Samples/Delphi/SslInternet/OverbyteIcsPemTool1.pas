...
const
     PemToolVersion     = 866;
     PemToolDate        = 'March 16, 2021';
     PemToolName        = 'PEM Certificate Tool';
     CopyRight : String = '(c) 2003-2021 by François PIETTE V8.66 ';
...
begin
    ...
    frmPemTool2 := TfrmPemTool2.Create(Self);
    try
        frmPemTool2.Caption := CAFilesDir.Text;
        frmPemTool2.Memo1.Lines.Clear;
...
begin
    ...
    if NOT GSSLStaticLinked then                          { V8.66 } 
        S := S + 'Dir: ' + GLIBEAY_DLL_FileName
     else
        S := S + 'Statically Linked';
    ShowMessage(S);
end;
...
begin
    ...
    try
        while pCertContext <> nil do begin
            xTmp := d2i_X509(nil, @pCertContext.pbCertEncoded, pCertContext.cbCertEncoded);
