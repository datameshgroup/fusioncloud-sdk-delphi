...
uses
  ...
  OverbyteIcsLogger, OverbyteIcsSslX509Utils, TypInfo,
...
const
     HttpsTstVersion     = 866;
     HttpsTstDate        = 'March 08, 2021';
     HttpsTstName        = 'HttpsTst';
     CopyRight : String  = ' HttpsTst (c) 2005-2021 Francois Piette V8.66 ';
...
begin
    ...
    { gone, pending new FIPS in OpenSSL 3.0 }
