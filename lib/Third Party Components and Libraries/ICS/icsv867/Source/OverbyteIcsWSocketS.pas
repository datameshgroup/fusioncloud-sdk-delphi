...
Sept 01, 2021 V8.67 OpenSSL 3.0 makes several old ciphers and digests legacy so default
...
const
    WSocketServerVersion     = 867;
    CopyRight : String       = ' TWSocketServer (c) 1999-2021 F. Piette V8.67 ';
