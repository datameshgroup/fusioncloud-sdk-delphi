...
{ end of autogenerated certificate bundle }

{ one extra new Let's Encrypt ECDSA root not yet in public bundles
...
begin
    result :=
        ...
        sslRootCACerts031 + sslRootCACerts032 + sslRootCACerts033 + sslRootCACerts034 + sslRootCACertsISRGX2;
    end ;
// total 34
