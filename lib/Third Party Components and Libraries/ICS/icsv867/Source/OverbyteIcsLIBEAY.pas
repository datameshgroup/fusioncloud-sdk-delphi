...
const
    IcsLIBEAYVersion   = 867;
    CopyRight : String = ' IcsLIBEAY (c) 2003-2021 F. Piette V8.67 ';
...
{ V8.67 new for OpenSSL 3.0 }
    ...
    OSSL_PROVIDER_gettable_params :          function(prov: POSSL_PROVIDER): TOSSL_PARAM; cdecl = nil;                     { V8.67 }
    ...
    EVP_PKEY_gettable_params :               function(pkey: PEVP_PKEY): POSSL_PARAM; cdecl = nil;                                    { V8.67 }
    ...
    EVP_PKEY_settable_params :               function(pkey: PEVP_PKEY): POSSL_PARAM; cdecl = nil;                                       { V8.67 }
    ...
    OSSL_PARAM_construct_int :               function(key: PAnsiChar; buf: PInteger): TOSSL_PARAM; cdecl = nil;            { V8.67 }
    OSSL_PARAM_construct_uint :              function(key: PAnsiChar; buf: uint): TOSSL_PARAM; cdecl = nil;                { V8.67 }
    OSSL_PARAM_construct_long :              function(key: PAnsiChar; buf: longword): TOSSL_PARAM; cdecl = nil;            { V8.67 }
    OSSL_PARAM_construct_ulong :             function(key: PAnsiChar; buf: ulong): TOSSL_PARAM; cdecl = nil;               { V8.67 }
    OSSL_PARAM_construct_int32 :             function(key: PAnsiChar; buf: integer): TOSSL_PARAM; cdecl = nil;               { V8.67 }
    OSSL_PARAM_construct_uint32 :            function(key: PAnsiChar; buf: uint): TOSSL_PARAM; cdecl = nil;              { V8.67 }
    OSSL_PARAM_construct_int64 :             function(key: PAnsiChar; buf: int64): TOSSL_PARAM; cdecl = nil;               { V8.67 }
    OSSL_PARAM_construct_uint64 :            function(key: PAnsiChar; buf: uint64): TOSSL_PARAM; cdecl = nil;              { V8.67 }
    OSSL_PARAM_construct_size_t :            function(key: PAnsiChar; buf: size_t): TOSSL_PARAM; cdecl = nil;              { V8.67 }
//  OSSL_PARAM_construct_time_t :            function(key: PAnsiChar; buf: time_t): TOSSL_PARAM; cdecl = nil;              { V8.67 }
    OSSL_PARAM_construct_BN :                function(key: PAnsiChar; buf: PAnsiChar; bsize: size_t): TOSSL_PARAM; cdecl = nil; { V8.67 }
    OSSL_PARAM_construct_double :            function(key: PAnsiChar; buf: double): TOSSL_PARAM; cdecl = nil;              { V8.67 }
    OSSL_PARAM_construct_utf8_string :       function(key: PAnsiChar; buf: PAnsiChar; bsize: size_t): TOSSL_PARAM; cdecl = nil;  { V8.67 }
    OSSL_PARAM_construct_utf8_ptr :          function(key: PAnsiChar; buf: PPAnsiChar; bsize: size_t): TOSSL_PARAM; cdecl = nil; { V8.67 }
    OSSL_PARAM_construct_octet_string :      function(key: PAnsiChar; buf: PAnsiChar; bsize: size_t): TOSSL_PARAM; cdecl = nil;  { V8.67 }
    OSSL_PARAM_construct_octet_ptr :         function(key: PAnsiChar; buf: PPAnsiChar; bsize: size_t): TOSSL_PARAM; cdecl = nil; { V8.67 }
    OSSL_PARAM_construct_end :               function: TOSSL_PARAM; cdecl = nil;                                                 { V8.67 }
...
const
    GLIBEAYImports1: array[0..740] of TOSSLImports = (
...
const
    ...
    BuffSize = 1024;
var
    StaticParams: array[0..TotBuff-1] of TOSSL_PARAM;
