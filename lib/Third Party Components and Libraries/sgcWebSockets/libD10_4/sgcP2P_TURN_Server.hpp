...
// (DO NOT EDIT: machine generated header) 'sgcP2P_TURN_Server.pas' rev: 34.00 (Windows)
...
protected:
	...
	virtual void __fastcall DoReadData(Sgcudp_classes::TsgcUDPSocket* const aSocket, const System::DynamicArray<System::Byte> Bytes);
...
protected:
	...
	virtual void __fastcall DoTURNReadChannelData(Sgcudp_classes::TsgcUDPSocket* const aSocket, const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoTransformPacketToDataIndication(Sgcudp_classes::TsgcUDPSocket* const aSocket, const System::UnicodeString aFromIP, System::Word aFromPort, Sgcwebsocket_types::TwsIPVersion aIPVersion, TsgcTURNAllocationItem* const aAllocation, const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoTransformPacketToChannelData(Sgcudp_classes::TsgcUDPSocket* const aSocket, TsgcTURNAllocationItem* const aAllocation, const System::DynamicArray<System::Byte> aBytes);
