...
// (DO NOT EDIT: machine generated header) 'sgcP2P_TURN_Client.pas' rev: 34.00 (Windows)
...
protected:
	virtual void __fastcall DoTURNReadChannelData(Sgcsocket_classes::TsgcSocketConnection* const aSocket, const System::DynamicArray<System::Byte> aBytes);
	...
	virtual void __fastcall DoSendIndication(const System::UnicodeString aPeerIP, System::Word aPeerPort, const System::DynamicArray<System::Byte> aData);
	...
	virtual void __fastcall DoSendChannelData(const System::Word aChannelID, const System::DynamicArray<System::Byte> aData);
...
public:
	...
	void __fastcall SendIndication(const System::UnicodeString aPeerIP, System::Word aPeerPort, const System::DynamicArray<System::Byte> aData)/* overload */;
	void __fastcall SendChannelData(const System::Word aChannelID, const System::UnicodeString aData)/* overload */;
	void __fastcall SendChannelData(const System::Word aChannelID, const System::DynamicArray<System::Byte> aData)/* overload */;
