...
// (DO NOT EDIT: machine generated header) 'sgcIdAuthenticationSSPI.pas' rev: 34.00 (Windows)

#ifndef SgcidauthenticationsspiHPP
#define SgcidauthenticationsspiHPP
...
//-- user supplied -----------------------------------------------------------
#pragma link "sgcIdAuthenticationSSPI"

namespace Sgcidauthenticationsspi
{
...
public:
	...
	bool __fastcall UpdateAndGenerateReply(const Sgcidglobal::TIdBytes aFromPeerToken, Sgcidglobal::TIdBytes &aToPeerToken);
public:
...
public:
	bool __fastcall GenerateInitialChallenge(const System::UnicodeString aTargetName, Sgcidglobal::TIdBytes &aToPeerToken);
...
public:
	...
	Sgcidglobal::TIdBytes __fastcall InitAndBuildType1Message();
	Sgcidglobal::TIdBytes __fastcall UpdateAndBuildType3Message(const Sgcidglobal::TIdBytes aServerType2Message);
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TIdSSPINTLMAuthentication : public Sgcidauthentication::TIdAuthentication
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDAUTHENTICATIONSSPI)
using namespace Sgcidauthenticationsspi;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// SgcidauthenticationsspiHPP
