...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Client.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TsgcWSOnSSLGetHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdSSLIOHandlerSocketBase* &aSSLHandler);

typedef void __fastcall (__closure *TsgcWSOnSSLAfterCreateHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdSSLIOHandlerSocketBase* aSSLHandler);

typedef void __fastcall (__closure *TsgcWSOnSSLVerifyPeer)(System::TObject* Sender, Sgcidsslopenssl::TIdX509* Certificate, bool AOk, int ADepth, int AError, bool &Accept);
...
protected:
	...
	void __fastcall DoDecodeHeader(Sgcidtcpconnection::TIdTCPConnection* const aConnection, Sgcidheaderlist::TIdHeaderList* aHeaders);
...
public:
	__fastcall virtual TsgcWSHandShakeClient(Sgcidtcpconnection::TIdTCPConnection* aConnection, Sgcidheaderlist::TIdHeaderList* aHeaders);
public:
...
public:
	void __fastcall DoInitialize(Sgcidtcpconnection::TIdTCPConnection* aConnection);
...
protected:
	...
	virtual bool __fastcall OnVerifyPeerEvent(Sgcidsslopenssl::TIdX509* Certificate, bool AOk, int ADepth, int AError);
