...
// (DO NOT EDIT: machine generated header) 'sgcHTTP2_Classes.pas' rev: 34.00 (Windows)
...
public:
	...
	void __fastcall AddNotifyObject(Sgctcp_classes::TsgcTCPConnection* const aConnection, System::TObject* const aObject, const System::DynamicArray<System::Byte> aBytes)/* overload */;
