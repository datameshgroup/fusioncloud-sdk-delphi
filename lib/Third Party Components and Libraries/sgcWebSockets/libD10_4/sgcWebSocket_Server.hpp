...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Server.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TsgcWSOnSSLGetHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdServerIOHandlerSSLBase* &aSSLHandler);

typedef void __fastcall (__closure *TsgcWSOnSSLAfterCreateHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdServerIOHandlerSSLBase* aSSLHandler);
...
typedef void __fastcall (__closure *TsgcWSOnBeforeForwardHTTP)(Sgcwebsocket_classes::TsgcWSConnection* Connection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcwebsocket_classes_indy::TsgcWSServerForwardHTTP* aForward);

typedef void __fastcall (__closure *TsgcWSOnAfterForwardHTTP)(Sgcwebsocket_classes::TsgcWSConnection* Connection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo, System::Sysutils::Exception* E);
...
private:
	HIDESBASE void __fastcall DoDecodeHeaders(Sgcidtcpconnection::TIdTCPConnection* const aConnection, Sgcidheaderlist::TIdHeaderList* aHeaders);
	
public:
	__fastcall virtual TsgcWSHandShakeServer(Sgcidtcpconnection::TIdTCPConnection* aConnection, Sgcidheaderlist::TIdHeaderList* aHeaders)/* overload */;
public:
...
protected:
	Sgcidcontext::TIdContext* FContext;
...
protected:
	virtual Sgcidcustomtcpserver::TIdCustomTCPServer* __fastcall GetCustomServer() = 0 ;
	__property Sgcidcustomtcpserver::TIdCustomTCPServer* CustomServer = {read=GetCustomServer};
...
protected:
	...
	virtual void __fastcall OnServerConnectEvent(Sgcidcontext::TIdContext* AContext);
	...
	virtual void __fastcall OnServerDisconnectEvent(Sgcidcontext::TIdContext* AContext);
	virtual void __fastcall OnServerExecuteEvent(Sgcidcontext::TIdContext* AContext);
...
private:
	...
	Sgcidsockethandle::TIdSocketHandles* __fastcall GetBindings();
...
public:
	...
	__property Sgcidsockethandle::TIdSocketHandles* Bindings = {read=GetBindings, write=SetBindings};
...
private:
	...
	Sgcidssl::TIdServerIOHandlerSSLBase* FHandlerSSL;
...
protected:
	...
	virtual void __fastcall GetHandlerSSLEvent(const Sgcwebsocket_types::TwsSSLHandler aSSLType, Sgcidssl::TIdServerIOHandlerSSLBase* &aSSLHandler);
...
protected:
	...
	virtual void __fastcall OnHTTP2RequestEvent(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, System::Classes::TStringList* const aHeaders, const System::DynamicArray<System::Byte> aBytes, int aStreamIdentifierRequest, int aStreamIdentifierPush, System::Classes::TStream* const aPostStream);
...
private:
	...
	Sgcidschedulerofthreadpool::TIdSchedulerOfThreadPool* FSchedulerThreadPool;
...
protected:
	...
	virtual void __fastcall DoContextFree(Sgcidcontext::TIdContext* AContext);
...
protected:
	...
	virtual void __fastcall OnHTTP2RequestEvent(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, System::Classes::TStringList* const aHeaders, const System::DynamicArray<System::Byte> aBytes, int aStreamIdentifierRequest, int aStreamIdentifierPush, System::Classes::TStream* const aPostStream);
	virtual Sgcidcustomtcpserver::TIdCustomTCPServer* __fastcall GetCustomServer();
	virtual void __fastcall OnServerExecuteEvent(Sgcidcontext::TIdContext* AContext);
	virtual void __fastcall OnServerDisconnectEvent(Sgcidcontext::TIdContext* AContext);
...
protected:
	Sgcidcustomhttpserver::TIdCustomHTTPServer* FHTTPServer;
	__property Sgcidcustomhttpserver::TIdCustomHTTPServer* HTTPServer = {read=FHTTPServer};
	bool __fastcall DoHTTP2Authentication(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, System::Classes::TStringList* const aHeaders);
	virtual bool __fastcall DoHTTP2Request(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, System::Classes::TStringList* const aHeaders, const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoHTTP2Response(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, Sgcidcustomhttpserver::TIdHTTPResponseInfo* const aResponse, int aStreamIdentifierRequest, int aStreamIdentifierPush = 0x0);
	virtual bool __fastcall DoHTTP2DocumentRoot(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, Sgcidcustomhttpserver::TIdHTTPResponseInfo* const aResponse);
	virtual bool __fastcall DoHTTP2BeforeCommandGet(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, Sgcidcustomhttpserver::TIdHTTPResponseInfo* const aResponse, int aStreamIdentifier);
	virtual void __fastcall DoHTTP2CommandGet(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, Sgcidcustomhttpserver::TIdHTTPResponseInfo* const aResponse, int aStreamIdentifierRequest, int aStreamIdentifierPush);
	virtual void __fastcall DoHTTP2CommandOther(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, Sgcidcustomhttpserver::TIdHTTPResponseInfo* const aResponse, int aStreamIdentifierRequest);
	virtual void __fastcall OnHTTP2RequestEvent(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, System::Classes::TStringList* const aHeaders, const System::DynamicArray<System::Byte> aBytes, int aStreamIdentifierRequest, int aStreamIdentifierPush, System::Classes::TStream* const aPostStream);
	virtual void __fastcall OnHTTP2ReadCreatePostStreamEvent(System::TObject* Sender, System::Classes::TStrings* const aHeaders, System::Classes::TStream* &Stream);
	virtual void __fastcall OnHTTP2ReadDonePostStreamEvent(System::TObject* Sender, System::Classes::TStrings* const aHeaders, System::Classes::TStream* const aStream);
	
private:
	Sgchttp2_classes::TsgcHTTP2PushPromiseList* FPushPromiseList;
	
protected:
	Sgchttp2_classes::TsgcHTTP2PushPromiseList* __fastcall GetPushPromiseList();
	
public:
	void __fastcall PushPromiseAddPreLoadLinks(const System::UnicodeString aPathMatch, System::Classes::TStrings* const aLinks);
	void __fastcall PushPromiseRemovePreLoadLinks(const System::UnicodeString aPathMatch);
	
private:
	System::UnicodeString FCharset;
	System::UnicodeString FDocumentRoot;
	Sgcidcustomhttpserver::TIdHTTPCreateSession FOnCreateSession;
	Sgcidcustomhttpserver::TIdHTTPInvalidSessionEvent FOnInvalidSession;
	Sgcidcustomhttpserver::TIdHTTPSessionEndEvent FOnSessionEnd;
	Sgcidcustomhttpserver::TIdHTTPSessionStartEvent FOnSessionStart;
...
protected:
	...
	Sgcidcustomhttpserver::TIdHTTPCommandEvent FOnCommandGet;
	Sgcidcustomhttpserver::TIdHTTPCommandEvent FOnCommandOther;
	virtual bool __fastcall DoBeforeOnCommand(Sgcwebsocket_classes::TsgcWSConnection* aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	virtual void __fastcall OnCommandGetEvent(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	virtual void __fastcall OnCommandOtherEvent(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	virtual void __fastcall OnCreateSessionEvent(Sgcidcontext::TIdContext* ASender, Sgcidcustomhttpserver::TIdHTTPSession* &VHTTPSession);
	virtual void __fastcall OnInvalidSessionEvent(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo, bool &VContinueProcessing, const System::UnicodeString AInvalidSessionID);
	virtual void __fastcall OnSessionStartEvent(Sgcidcustomhttpserver::TIdHTTPSession* Sender);
	virtual void __fastcall OnSessionEndEvent(Sgcidcustomhttpserver::TIdHTTPSession* Sender);
	virtual void __fastcall OnExceptionEvent(Sgcidcontext::TIdContext* AContext, System::Sysutils::Exception* AException);
	virtual void __fastcall OnServerParseAuthenticationEvent(Sgcidcontext::TIdContext* AContext, const System::UnicodeString AAuthType, const System::UnicodeString AAuthData, System::UnicodeString &VUsername, System::UnicodeString &VPassword, bool &VHandled);
	virtual void __fastcall OnCreatePostStreamEvent(Sgcidcontext::TIdContext* AContext, Sgcidheaderlist::TIdHeaderList* aHeaders, System::Classes::TStream* &VPostStream);
	virtual void __fastcall OnDoneWithPostStreamEvent(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, bool &VCanFree);
	virtual bool __fastcall DoResponseHTTP(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	virtual void __fastcall DoResponseAfterCommand(TsgcWSConnectionServer* aConnection, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	System::UnicodeString __fastcall GetCustomHeadersFromRaw(Sgcidheaderlist::TIdHeaderList* aRawHeaders);
	virtual bool __fastcall DoForwardHTTP(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo);
	
public:
	__property Sgcidcustomhttpserver::TIdHTTPCommandEvent OnCommandGet = {read=FOnCommandGet, write=FOnCommandGet};
	__property Sgcidcustomhttpserver::TIdHTTPCommandEvent OnCommandOther = {read=FOnCommandOther, write=FOnCommandOther};
	__property Sgcidcustomhttpserver::TIdHTTPCreateSession OnCreateSession = {read=FOnCreateSession, write=FOnCreateSession};
	__property Sgcidcustomhttpserver::TIdHTTPInvalidSessionEvent OnInvalidSession = {read=FOnInvalidSession, write=FOnInvalidSession};
	__property Sgcidcustomhttpserver::TIdHTTPSessionEndEvent OnSessionEnd = {read=FOnSessionEnd, write=FOnSessionEnd};
	__property Sgcidcustomhttpserver::TIdHTTPSessionStartEvent OnSessionStart = {read=FOnSessionStart, write=FOnSessionStart};
...
private:
	...
	Sgcidcustomhttpserver::TIdHTTPCustomSessionList* __fastcall GetSessionList();
...
public:
	...
	__property Sgcidcustomhttpserver::TIdHTTPCustomSessionList* SessionList = {read=GetSessionList};
...
protected:
	virtual void __fastcall DoExecuteHTTP(Sgcidcontext::TIdContext* AContext);
	virtual Sgcidcustomtcpserver::TIdCustomTCPServer* __fastcall GetCustomServer();
	virtual void __fastcall OnServerExecuteEvent(Sgcidcontext::TIdContext* AContext);
	virtual void __fastcall OnServerDisconnectEvent(Sgcidcontext::TIdContext* AContext);
	virtual bool __fastcall DoHTTPBasicAuthentication(Sgcwebsocket_classes::TsgcWSConnection* aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* &ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* &AResponseInfo);
