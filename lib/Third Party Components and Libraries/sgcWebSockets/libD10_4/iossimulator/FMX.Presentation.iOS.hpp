...
// (DO NOT EDIT: machine generated header) 'FMX.Presentation.iOS.pas' rev: 34.00 (iOSSIM)
...
protected:
	virtual System::Typinfo::PTypeInfo __fastcall GetObjectiveCClass();
	void __fastcall RegisterNativeEventHandler(const System::UnicodeString ASelector, const unsigned AEvents);
	void __fastcall UnRegisterNativeEventHandler(const System::UnicodeString ASelector, const unsigned AEvents);
