...
// (DO NOT EDIT: machine generated header) 'FMX.Forms.pas' rev: 34.00 (iOSSIM)
...
struct TDeviceKindHelper /* Helper for enum 'TDeviceKind' */;
struct TFormOrientationHelper /* Helper for enum 'Fmx::Types::TScreenOrientation' */;
...
struct TFmxFormBorderStyleHelper /* Helper for enum 'TFmxFormBorderStyle' */;
struct TFmxFormStateHelper /* Helper for enum 'TFmxFormState' */;
struct TFormPositionHelper /* Helper for enum 'TFormPosition' */;
...
struct TWindowStyleHelper /* Helper for enum 'TWindowStyle' */;
...
__interface IDesignerHook  : public System::IInterface 
{
	
};

__interface IDesignerStorage  : public System::IInterface 
{
	
};

enum class DECLSPEC_DENUM TApplicationState : unsigned int { None, Running, Terminating, Terminated, asNone _DEPRECATED_ATTRIBUTE3("Use TApplicationState.None")  = 0, asRunning _DEPRECATED_ATTRIBUTE3("Use TApplicationState.Running")  = 1, asTerminating _DEPRECATED_ATTRIBUTE3("Use TApplicationState.Terminating")  = 2, asTerminated _DEPRECATED_ATTRIBUTE3("Use TApplicationState.Terminated")  = 3 };
...
enum class DECLSPEC_DENUM TFmxFormBorderStyle : unsigned int { None, Single, Sizeable, ToolWindow, SizeToolWin, bsNone _DEPRECATED_ATTRIBUTE3("Use TFmxFormBorderStyle.None")  = 0, bsSingle _DEPRECATED_ATTRIBUTE3("Use TFmxFormBorderStyle.Single")  = 1, bsSizeable _DEPRECATED_ATTRIBUTE3("Use TFmxFormBorderStyle.Sizeable")  = 2, bsToolWindow _DEPRECATED_ATTRIBUTE3("Use TFmxFormBorderStyle.ToolWindow")  = 3, bsSizeToolWin _DEPRECATED_ATTRIBUTE3("Use TFmxFormBorderStyle.SizeToolWin")  = 4 };
...
private:
	static constexpr System::WideChar UniqueNameSeparator = (System::WideChar)(0x5f);
	
	#define TFormSaveState_UniqueNamePrefix u"FM"
	
	#define TFormSaveState_UniqueNameExtension u".TMP"
...
public:
	static constexpr System::Uitypes::TAlphaColor DefaultBackgroundColor = System::Uitypes::TAlphaColor(0x0);
...
private:
	...
	System::Types::TPointF FDefaultClientSize;
...
public:
	...
	System::Types::TSize __fastcall Size();
...
#define DefaultFormStyleLookup u"backgroundstyle"
