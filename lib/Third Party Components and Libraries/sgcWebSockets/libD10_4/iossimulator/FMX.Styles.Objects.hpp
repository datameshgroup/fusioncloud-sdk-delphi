...
// (DO NOT EDIT: machine generated header) 'FMX.Styles.Objects.pas' rev: 34.00 (iOSSIM)
...
struct TStyleTriggerHelper /* Helper for enum 'TStyleTrigger' */;
class DELPHICLASS TBitmapLink;
struct TCapWrapModeHelper /* Helper for enum 'TCapWrapMode' */;
...
//-- type declarations -------------------------------------------------------
enum class DECLSPEC_DENUM TStyleTrigger : unsigned char { MouseOver, Pressed, Selected, Focused, Checked, Active, stMouseOver _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.MouseOver")  = 0, stPressed _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.Pressed")  = 1, stSelected _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.Selected")  = 2, stFocused _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.Focused")  = 3, stChecked _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.Checked")  = 4, stActive _DEPRECATED_ATTRIBUTE3("Use TStyleTrigger.Active")  = 5 };
...
enum class DECLSPEC_DENUM TCapWrapMode : unsigned char { Stretch, Tile, cmStretch _DEPRECATED_ATTRIBUTE3("Use TCapWrapMode.Stretch")  = 0x0, cmTile _DEPRECATED_ATTRIBUTE3("Use TCapWrapMode.Tile")  = 0x1 };
...
public:
	...
	static constexpr System::Int8 DefaultPressingDuration = System::Int8(0x1);
