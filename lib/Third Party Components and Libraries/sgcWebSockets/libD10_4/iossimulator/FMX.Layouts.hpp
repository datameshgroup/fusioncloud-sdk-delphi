...
// (DO NOT EDIT: machine generated header) 'FMX.Layouts.pas' rev: 34.00 (iOSSIM)
...
struct TFlowJustifyHelper /* Helper for enum 'TFlowJustify' */;
struct TFlowDirectionHelper /* Helper for enum 'TFlowDirection' */;
...
public:
	enum class DECLSPEC_DENUM TSizeStyle : unsigned char { Absolute, Percent, Auto, ssAbsolute _DEPRECATED_ATTRIBUTE3("Use TSizeStyle.Absolute")  = 0x0, ssPercent _DEPRECATED_ATTRIBUTE3("Use TSizeStyle.Percent")  = 0x1, ssAuto _DEPRECATED_ATTRIBUTE3("Use TSizeStyle.Auto")  = 0x2 };
	
	struct TSizeStyleHelper /* Helper for enum 'TSizeStyle' */;
...
public:
	...
	_DECLARE_ARITH_TYPE_ALIAS(int, TCellSpan);
...
public:
	...
	struct TExpandStyleHelper /* Helper for enum 'TExpandStyle' */;
