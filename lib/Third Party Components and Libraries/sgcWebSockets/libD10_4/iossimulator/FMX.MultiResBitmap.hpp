...
// (DO NOT EDIT: machine generated header) 'FMX.MultiResBitmap.pas' rev: 34.00 (iOSSIM)
...
struct TSizeKindHelper /* Helper for enum 'TSizeKind' */;
...
public:
	static constexpr System::Int8 ScaleRange = System::Int8(-3);
	
	static constexpr System::Int8 ScaleMax = System::Int8(0x64);
	
	static constexpr System::Int8 ScaleDefault = System::Int8(0x1);
