...
// (DO NOT EDIT: machine generated header) 'FMX.Controls.Model.pas' rev: 34.00 (iOSSIM)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_BASE = System::Word(0x1600);
static constexpr System::Word MM_GETDATA = System::Word(0x1601);
static constexpr System::Word MM_DATA_CHANGED = System::Word(0x1602);
static constexpr System::Word MM_USER = System::Word(0x1700);
}	/* namespace Model */
}	/* namespace Controls */
}	/* namespace Fmx */
