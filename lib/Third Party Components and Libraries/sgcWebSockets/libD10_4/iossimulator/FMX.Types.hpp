...
// (DO NOT EDIT: machine generated header) 'FMX.Types.pas' rev: 34.00 (iOSSIM)
...
struct TVKAutoShowModeHelper /* Helper for enum 'TVKAutoShowMode' */;
struct TCornerHelper /* Helper for enum 'TCorner' */;
struct TCornerTypeHelper /* Helper for enum 'TCornerType' */;
struct TSideHelper /* Helper for enum 'TSide' */;
...
struct TTextTrimmingHelper /* Helper for enum 'TTextTrimming' */;
struct TStyledSettingHelper /* Helper for enum 'TStyledSetting' */;
struct TMenuItemChangeHelper /* Helper for enum 'TMenuItemChange' */;
struct TScreenOrientationHelper /* Helper for enum 'TScreenOrientation' */;
struct TGestureEventInfo;
struct TTouch;
struct TFormStyleHelper /* Helper for enum 'TFormStyle' */;
...
struct TVirtualKeyboardTypeHelper /* Helper for enum 'TVirtualKeyboardType' */;
struct TVirtualKeyboardStateHelper /* Helper for enum 'TVirtualKeyboardState' */;
...
struct TInteractiveGestureHelper /* Helper for enum 'TInteractiveGesture' */;
struct TGestureTypeHelper /* Helper for enum 'TGestureType' */;
...
enum class DECLSPEC_DENUM TMenuItemChange : unsigned int { Enabled, Visible, Text, Shortcut, Checked, Bitmap, mcEnabled _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Enabled")  = 0, mcVisible _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Visible")  = 1, mcText _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Text")  = 2, mcShortcut _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Shortcut")  = 3, mcChecked _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Checked")  = 4, mcBitmap _DEPRECATED_ATTRIBUTE3("Use TMenuItemChange.Bitmap")  = 5 };
...
_DECLARE_ARITH_TYPE_ALIAS(short, TGestureID);
...
enum class DECLSPEC_DENUM TFormStyle : unsigned int { Normal, Popup, StayOnTop, fsNormal _DEPRECATED_ATTRIBUTE3("Use TFormStyle.Normal")  = 0x0, fsPopup _DEPRECATED_ATTRIBUTE3("Use TFormStyle.Popup")  = 0x1, fsStayOnTop _DEPRECATED_ATTRIBUTE3("Use TFormStyle.StayOnTop")  = 0x2 };
...
_DECLARE_ARITH_TYPE_ALIAS(short, TFlasherInterval);
...
__interface  INTERFACE_UUID("{7318D022-D048-49DE-BF55-C5C36A2AD1AC}") IControl  : public IFreeNotificationBehavior 
{
	...
	virtual _di_IControl __fastcall ObjectAtPoint(const System::Types::TPointF &P) = 0 ;
...
_DECLARE_STRING_TYPE_ALIAS(System::UnicodeString, TTrigger);
...
typedef System::Generics::Collections::TList__1<TFmxObject*>* TFmxObjectList;
...
enum class DECLSPEC_DENUM TGestureOption : unsigned int { UniDirectional, Skew, Endpoint, Rotate, goUniDirectional _DEPRECATED_ATTRIBUTE3("Use TGestureOption.UniDirectional")  = 0, goSkew _DEPRECATED_ATTRIBUTE3("Use TGestureOption.Skew")  = 1, goEndpoint _DEPRECATED_ATTRIBUTE3("Use TGestureOption.Endpoint")  = 2, goRotate _DEPRECATED_ATTRIBUTE3("Use TGestureOption.Rotate")  = 3 };
...
public:
	...
	struct TGestureEngineFlagHelper /* Helper for enum 'TGestureEngineFlag' */;
...
enum class DECLSPEC_DENUM TKeyKind : unsigned int { Usual, Functional, Unknown, kkUsual _DEPRECATED_ATTRIBUTE3("Use TKeyKind.Usual")  = 0x0, kkFunctional _DEPRECATED_ATTRIBUTE3("Use TKeyKind.Functional")  = 0x1, kkUnknown _DEPRECATED_ATTRIBUTE3("Use TKeyKind.Unknown")  = 0x2 };
