...
// (DO NOT EDIT: machine generated header) 'FMX.Ani.pas' rev: 34.00 (iOSSIM)
...
{
	virtual void __fastcall StartTriggerAnimation(Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger) = 0 ;
	virtual void __fastcall StartTriggerAnimationWait(Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger) = 0 ;
};
...
public:
	...
	__classmethod void __fastcall StartTriggerAnimation(Fmx::Types::TFmxObject* const Target, Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger);
	__classmethod void __fastcall StartTriggerAnimationWait(Fmx::Types::TFmxObject* const Target, Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger);
	...
	static void __fastcall DefaultStartTriggerAnimation(Fmx::Types::TFmxObject* const Target, Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger);
	__classmethod void __fastcall DefaultStartTriggerAnimationWait(Fmx::Types::TFmxObject* const Target, Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger);
...
private:
	struct DECLSPEC_DRECORD TTriggerRec
	{
	public:
...
public:
	static constexpr System::Int8 DefaultAniFrameRate = System::Int8(0x3c);
...
private:
	...
	Fmx::Types::TTrigger FTriggerInverse;
	bool FLoop;
	bool FPause;
	bool FRunning;
	...
	bool FEnabled;
	bool FAutoReverse;
	System::Generics::Collections::TList__1<TTriggerRec>* FTriggerList;
	System::Generics::Collections::TList__1<TTriggerRec>* FInverseTriggerList;
	System::TClass FTargetClass;
	void __fastcall SetEnabled(const bool Value);
	void __fastcall SetTrigger(const Fmx::Types::TTrigger Value);
	void __fastcall SetTriggerInverse(const Fmx::Types::TTrigger Value);
	void __fastcall ParseTriggers(Fmx::Types::TFmxObject* const AInstance, bool Normal, bool Inverse);
	__classmethod void __fastcall Uninitialize();
...
public:
	...
	void __fastcall StopTrigger(Fmx::Types::TFmxObject* const AInstance, const System::UnicodeString ATrigger);
