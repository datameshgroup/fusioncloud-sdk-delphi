...
// (DO NOT EDIT: machine generated header) 'FMX.Platform.Metrics.iOS.pas' rev: 34.00 (iOSSIM)

#ifndef Fmx_Platform_Metrics_IosHPP
#define Fmx_Platform_Metrics_IosHPP
...
class DELPHICLASS TCocoaTouchMetricsServices;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TCocoaTouchMetricsServices : public System::TInterfacedObject
{
	typedef System::TInterfacedObject inherited;
	
public:
	static constexpr System::Int8 DefaultiOSFontSize = System::Int8(0xe);
	
	
private:
	System::UnicodeString FDefaultiOSFontName;
...
public:
	__fastcall TCocoaTouchMetricsServices();
	__fastcall virtual ~TCocoaTouchMetricsServices();
	...
	Fmx::Platform::TCaretBehaviors __fastcall GetCaretBehaviors();
...
private:
	...
	void *__IFMXTextEditingService;	// Fmx::Platform::IFMXTextEditingService 
...
public:
	...
	operator Fmx::Platform::_di_IFMXTextEditingService()
	{
		Fmx::Platform::_di_IFMXTextEditingService intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Fmx::Platform::IFMXTextEditingService*(void) { return (Fmx::Platform::IFMXTextEditingService*)&__IFMXTextEditingService; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_PLATFORM_METRICS_IOS)
using namespace Fmx::Platform::Metrics::Ios;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_Platform_Metrics_IosHPP
