...
// (DO NOT EDIT: machine generated header) 'FMX.Objects3D.pas' rev: 34.00 (iOSSIM)
...
struct TExtrudedShapeSideHelper /* Helper for enum 'TExtrudedShapeSide' */;
...
enum class DECLSPEC_DENUM TExtrudedShapeSide : unsigned char { Front, Back, Shaft, esFront _DEPRECATED_ATTRIBUTE3("Use TExtrudedShapeSide.Front")  = 0x0, esBack _DEPRECATED_ATTRIBUTE3("Use TExtrudedShapeSide.Back")  = 0x1, esShaft _DEPRECATED_ATTRIBUTE3("Use TExtrudedShapeSide.Shaft")  = 0x2 };
