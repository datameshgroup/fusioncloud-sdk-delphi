...
// (DO NOT EDIT: machine generated header) 'FMX.Styles.Switch.pas' rev: 34.00 (iOSSIM)
...
public:
	...
	static constexpr System::Int8 TrackingSensitivity = System::Int8(0x3);
	
	static constexpr System::Int8 TextClipOffset = System::Int8(0x4);
