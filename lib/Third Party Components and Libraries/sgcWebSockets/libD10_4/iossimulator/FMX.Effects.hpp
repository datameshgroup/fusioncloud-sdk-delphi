...
// (DO NOT EDIT: machine generated header) 'FMX.Effects.pas' rev: 34.00 (iOSSIM)
...
struct TEffectStyleHelper /* Helper for enum 'TEffectStyle' */;
...
enum class DECLSPEC_DENUM TEffectStyle : unsigned char { AfterPaint, DisablePaint, DisablePaintToBitmap, esAfterPaint _DEPRECATED_ATTRIBUTE3("Use TEffectStyle.AfterPaint")  = 0x0, esDisablePaint _DEPRECATED_ATTRIBUTE3("Use TEffectStyle.DisablePaint")  = 0x1, esDisablePaintToBitmap _DEPRECATED_ATTRIBUTE3("Use TEffectStyle.DisablePaintToBitmap")  = 0x2 };
