...
// (DO NOT EDIT: machine generated header) 'FMX.Helpers.iOS.pas' rev: 34.00 (iOSSIM)
...
extern DELPHI_PACKAGE int __fastcall TextAlignToUITextAlignment(const Fmx::Types::TTextAlign ATextAlignment);
extern DELPHI_PACKAGE int __fastcall VirtualKeyboardTypeToUIKeyboardType(const Fmx::Types::TVirtualKeyboardType AVirtualKeyboardType);
extern DELPHI_PACKAGE int __fastcall ReturnKeyTypeToUIReturnKeyType(const Fmx::Types::TReturnKeyType AReturnKeyType);
...
extern DELPHI_PACKAGE int __fastcall ScreenOrientationToUIInterfaceOrientation(const Fmx::Types::TScreenOrientations ASource);
extern DELPHI_PACKAGE int __fastcall GetUserInterfaceStyle(void);
}	/* namespace Ios */
}	/* namespace Helpers */
}	/* namespace Fmx */
