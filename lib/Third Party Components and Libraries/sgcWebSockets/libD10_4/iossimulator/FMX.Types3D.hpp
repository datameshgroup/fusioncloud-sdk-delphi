...
// (DO NOT EDIT: machine generated header) 'FMX.Types3D.pas' rev: 34.00 (iOSSIM)
...
struct TLightTypeHelper /* Helper for enum 'TLightType' */;
...
struct TProjectionHelper /* Helper for enum 'TProjection' */;
struct TMultisampleHelper /* Helper for enum 'TMultisample' */;
struct TClearTargetHelper /* Helper for enum 'TClearTarget' */;
struct TStencilOpHelper /* Helper for enum 'TStencilOp' */;
struct TStencilFuncHelper /* Helper for enum 'TStencilFunc' */;
struct TPrimitivesKindHelper /* Helper for enum 'TPrimitivesKind' */;
...
_DECLARE_ARITH_TYPE_ALIAS(NativeUInt, TContextShaderHandle);
...
enum class DECLSPEC_DENUM TMultisample : unsigned char { None, TwoSamples, FourSamples, msNone _DEPRECATED_ATTRIBUTE3("Use TMultisample.None")  = 0x0, ms2Samples _DEPRECATED_ATTRIBUTE3("Use TMultisample.TwoSamples")  = 0x1, ms4Samples _DEPRECATED_ATTRIBUTE3("Use TMultisample.FourSamples")  = 0x2 };
...
enum class DECLSPEC_DENUM TStencilFunc : unsigned char { Never, Less, Lequal, Greater, Gequal, Equal, NotEqual, Always, sfNever _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Never")  = 0, sfLess _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Less")  = 1, sfLequal _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Lequal")  = 2, sfGreater _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Greater")  = 3, sfGequal _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Gequal")  = 4, sfEqual _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Equal")  = 5, sfNotEqual _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.NotEqual")  = 6, sfAlways _DEPRECATED_ATTRIBUTE3("Use TStencilFunc.Always")  = 7 };
...
protected:
	static constexpr System::Int8 DefaultMaxLightCount = System::Int8(0x8);
	
	static constexpr System::Int8 DefaultTextureUnitCount = System::Int8(0x8);
	
	static constexpr System::Int8 DefaultScale = System::Int8(0x1);
	
	static constexpr int MaxInt16Vertices = int(0x10000);
	
	static constexpr int MaxInt16Indices = int(0x10000);
...
static constexpr System::Word MaxLightCount = System::Word(0x100);
