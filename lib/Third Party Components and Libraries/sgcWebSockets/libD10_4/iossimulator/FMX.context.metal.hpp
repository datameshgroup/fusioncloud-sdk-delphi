...
// (DO NOT EDIT: machine generated header) 'FMX.Context.Metal.pas' rev: 34.00 (iOSSIM)
...
private:
	...
	unsigned FStencilReferenceValue;
...
extern DELPHI_PACKAGE unsigned __fastcall PixelFormatToMTLPixelFormat(const Fmx::Types::TPixelFormat ASource);
