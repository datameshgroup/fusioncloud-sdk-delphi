...
// (DO NOT EDIT: machine generated header) 'FMX.Objects.pas' rev: 34.00 (iOSSIM)
...
struct TCalloutPositionHelper /* Helper for enum 'TCalloutPosition' */;
...
struct TImageWrapModeHelper /* Helper for enum 'TImageWrapMode' */;
...
public:
	static constexpr unsigned DefaultColor = unsigned(0xff1072c5);
