...
// (DO NOT EDIT: machine generated header) 'FMX.Controls.Presentation.pas' rev: 34.00 (iOSSIM)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word PM_BASE = System::Word(0x400);
static constexpr System::Word PM_INIT = System::Word(0x401);
static constexpr System::Word PM_UNLOAD = System::Word(0x402);
static constexpr System::Word PM_SET_VISIBLE = System::Word(0x406);
static constexpr System::Word PM_GET_VISIBLE = System::Word(0x407);
static constexpr System::Word PM_SET_ABSOLUTE_OPACITY = System::Word(0x408);
static constexpr System::Word PM_GET_ABSOLUTE_OPACITY = System::Word(0x409);
static constexpr System::Word PM_SET_SIZE = System::Word(0x40a);
static constexpr System::Word PM_GET_SIZE = System::Word(0x40b);
static constexpr System::Word PM_SET_ABSOLUTE_ENABLED = System::Word(0x40c);
static constexpr System::Word PM_GET_ABSOLUTE_ENABLED = System::Word(0x40d);
static constexpr System::Word PM_SET_CLIP_CHILDREN = System::Word(0x40e);
static constexpr System::Word PM_GET_CLIP_CHILDREN = System::Word(0x40f);
static constexpr System::Word PM_SET_STYLE_LOOKUP = System::Word(0x410);
static constexpr System::Word PM_GET_STYLE_LOOKUP = System::Word(0x411);
static constexpr System::Word PM_GET_NATIVE_OBJECT = System::Word(0x414);
static constexpr System::Word PM_GET_RECOMMEND_SIZE = System::Word(0x416);
static constexpr System::Word PM_IS_FOCUSED = System::Word(0x419);
static constexpr System::Word PM_RESET_FOCUS = System::Word(0x41a);
static constexpr System::Word PM_DO_ENTER = System::Word(0x421);
static constexpr System::Word PM_DO_BEFORE_EXIT = System::Word(0x43c);
static constexpr System::Word PM_DO_EXIT = System::Word(0x422);
static constexpr System::Word PM_REALIGN = System::Word(0x41c);
static constexpr System::Word PM_REFRESH_PARENT = System::Word(0x41d);
static constexpr System::Word PM_PARENT_CHANGED = System::Word(0x41e);
static constexpr System::Word PM_ANCESSTOR_VISIBLE_CHANGED = System::Word(0x41f);
static constexpr System::Word PM_KEYDOWN = System::Word(0x420);
static constexpr System::Word PM_KEYUP = System::Word(0x423);
static constexpr System::Word PM_ACTION_CLIENT_CHANGED = System::Word(0x424);
static constexpr System::Word PM_ACTION_CHANGE = System::Word(0x425);
static constexpr System::Word PM_APPLY_STYLE_LOOKUP = System::Word(0x426);
static constexpr System::Word PM_SET_STYLES_DATA = System::Word(0x427);
static constexpr System::Word PM_GET_STYLES_DATA = System::Word(0x428);
static constexpr System::Word PM_ABSOLUTE_CHANGED = System::Word(0x429);
static constexpr System::Word PM_HITTEST_CHANGED = System::Word(0x42a);
static constexpr System::Word PM_GET_ADJUST_TYPE = System::Word(0x42b);
static constexpr System::Word PM_GET_ADJUST_SIZE = System::Word(0x42c);
static constexpr System::Word PM_SET_ADJUST_SIZE = System::Word(0x42d);
static constexpr System::Word PM_NEED_STYLE_LOOKUP = System::Word(0x42e);
static constexpr System::Word PM_ANCESTOR_PRESENTATION_LOADED = System::Word(0x42f);
static constexpr System::Word PM_FIND_STYLE_RESOURCE = System::Word(0x430);
static constexpr System::Word PM_OBJECT_AT_POINT = System::Word(0x431);
static constexpr System::Word PM_POINT_IN_OBJECT_LOCAL = System::Word(0x432);
static constexpr System::Word PM_CHANGE_ORDER = System::Word(0x433);
static constexpr System::Word PM_START_TRIGGER_ANIMATION = System::Word(0x434);
static constexpr System::Word PM_APPLY_TRIGGER_EFFECT = System::Word(0x435);
static constexpr System::Word PM_GET_RESOURCE_LINK = System::Word(0x436);
static constexpr System::Word PM_SET_ADJUST_TYPE = System::Word(0x437);
static constexpr System::Word PM_ROOT_CHANGED = System::Word(0x438);
static constexpr System::Word PM_MOUSE_WHEEL = System::Word(0x439);
static constexpr System::Word PM_GET_FIRST_CONTROL_WITH_GESTURE = System::Word(0x43a);
static constexpr System::Word PM_ANCESTOR_PRESENTATION_UNLOADING = System::Word(0x43b);
static constexpr System::Word PM_PAINT_CHILDREN = System::Word(0x43a);
static constexpr System::Word PM_USER = System::Word(0x1000);
}	/* namespace Presentation */
}	/* namespace Controls */
}	/* namespace Fmx */
