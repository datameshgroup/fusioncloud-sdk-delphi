...
// (DO NOT EDIT: machine generated header) 'FMX.Controls.pas' rev: 34.00 (iOSSIM)
...
struct TOrientationHelper /* Helper for enum 'TOrientation' */;
...
__interface  INTERFACE_UUID("{16DB110E-DA7D-4E75-BC2D-999FA12E45F5}") IScene  : public IStyleBookOwner 
{
	...
	virtual void __fastcall ChangeScrollingState(TControl* const AControl, const bool Active) = 0 ;
...
private:
	#define TCaret_FMXFlasher u"FMXFlasher"
...
private:
	static constexpr System::Int8 InitialControlsCapacity = System::Int8(0xa);
	
	
public:
	static constexpr System::Int8 DefaultTouchTargetExpansion = System::Int8(0x6);
	
	#define TControl_DefaultDisabledOpacity  (6.000000E-01)
	
	static constexpr unsigned DesignBorderColor = unsigned(0xa0909090);
...
public:
	...
	virtual System::Types::TPointF __fastcall AbsoluteToLocal(const System::Types::TPointF &Point)/* overload */;
	System::Types::TRectF __fastcall AbsoluteToLocal(const System::Types::TRectF &ARect)/* overload */;
	virtual System::Types::TPointF __fastcall LocalToAbsolute(const System::Types::TPointF &Point)/* overload */;
...
enum class DECLSPEC_DENUM TOrientation : unsigned char { Horizontal, Vertical, orHorizontal _DEPRECATED_ATTRIBUTE3("Use TOrientation.Horizontal")  = 0x0, orVertical _DEPRECATED_ATTRIBUTE3("Use TOrientation.Vertical")  = 0x1 };
...
public:
	#define TStyledControl_StyleSuffix u"style"
...
public:
	#define TStyleCollectionItem_DefaultItem u"Default"
