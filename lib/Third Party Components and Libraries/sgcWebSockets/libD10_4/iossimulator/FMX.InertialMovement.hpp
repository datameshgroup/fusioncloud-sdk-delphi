...
// (DO NOT EDIT: machine generated header) 'FMX.InertialMovement.pas' rev: 34.00 (iOSSIM)
...
public:
	...
	struct TTargetTypeHelper /* Helper for enum 'TTargetType' */;
...
static constexpr System::Int8 DefaultIntervalOfAni = System::Int8(0xa);
#define DecelerationRateNormal  (1.950000E+00)
#define DecelerationRateFast  (9.500000E+00)
static constexpr System::Int8 DefaultElasticity = System::Int8(0x64);
static constexpr System::Int8 DefaultMinVelocity = System::Int8(0xa);
static constexpr System::Word DefaultMaxVelocity = System::Word(0x1388);
static constexpr System::Int8 DefaultDeadZone = System::Int8(0x8);
}	/* namespace Inertialmovement */
}	/* namespace Fmx */
