...
// (DO NOT EDIT: machine generated header) 'FMX.ImgList.pas' rev: 34.00 (iOSSIM)
...
public:
	#define TCustomSourceItem_DefaultName u"Item 0"
	
	#define TCustomSourceItem_TemporaryName u"Tmp_Item 0"
	
	static constexpr System::Int8 DefaultDesktopSize = System::Int8(0x10);
...
public:
	#define TCustomDestinationItem_StrDestinationDisplay u"%d (%s)"
...
public:
	static constexpr unsigned DesignBorderColor = unsigned(0xa080d080);
