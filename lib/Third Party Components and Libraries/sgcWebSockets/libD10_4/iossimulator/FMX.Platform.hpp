...
// (DO NOT EDIT: machine generated header) 'FMX.Platform.pas' rev: 34.00 (iOSSIM)
...
__interface  INTERFACE_UUID("{133A6050-AC29-4233-9EE2-D49082C33BBF}") IFMXMultiDisplayService  : public System::IInterface 
{
	...
	virtual System::Types::TRect __fastcall GetWorkAreaRect() = 0 ;
	virtual System::Types::TRect __fastcall GetDesktopRect() = 0 ;
	virtual Fmx::Types::TDisplay __fastcall GetDisplay(const int Index) = 0 ;
	virtual System::Types::TRect __fastcall GetDesktopCenterRect(const System::Types::TSize &Size) = 0 ;
