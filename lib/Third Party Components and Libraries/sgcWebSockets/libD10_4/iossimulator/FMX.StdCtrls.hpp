...
// (DO NOT EDIT: machine generated header) 'FMX.StdCtrls.pas' rev: 34.00 (iOSSIM)
...
struct TAniIndicatorStyleHelper /* Helper for enum 'TAniIndicatorStyle' */;
...
public:
	...
	static constexpr System::Int8 DefaultCalloutWidth = System::Int8(0x17);
	
	static constexpr System::Int8 DefaultCalloutLength = System::Int8(0xb);
...
private:
	static constexpr System::Int8 FirstInterval = System::Int8(0xa);
	
	static constexpr System::Word SecondInterval = System::Word(0x1f4);
	
	static constexpr System::Int8 OtherInterval = System::Int8(0x14);
...
enum class DECLSPEC_DENUM TAniIndicatorStyle : unsigned char { Linear, Circular, aiLinear _DEPRECATED_ATTRIBUTE3("Use TAniIndicatorStyle.Linear")  = 0x0, aiCircular _DEPRECATED_ATTRIBUTE3("Use TAniIndicatorStyle.Circular")  = 0x1 };
...
public:
	static constexpr System::Int8 cDefaultHeaderHeight = System::Int8(0x19);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_VALUE_CHANGED = System::Word(0x1701);
}	/* namespace Stdctrls */
}	/* namespace Fmx */
