...
// (DO NOT EDIT: machine generated header) 'sgcHTTP2_HPACK.pas' rev: 34.00 (Windows)
...
private:
	void __fastcall DoHuffmanResizeBuffer(System::DynamicArray<System::Byte> &aBytes, int aUsedBytes, int aNewBytes);
...
protected:
	...
	int __fastcall DoHuffmanEncodeInto(System::DynamicArray<System::Byte> aBuf, int aBufOffset, System::DynamicArray<System::Byte> aBytes, int aBytesOffset);
	System::UnicodeString __fastcall DoHuffmanDecode(System::DynamicArray<System::Byte> aInput);
	int __fastcall GetHuffmanEncodedLength(System::DynamicArray<System::Byte> aData, int aOffset = 0x0);
	
private:
	int __fastcall DoEncodeInteger(int aValue, int aNumBits, int aPrefixBits, int aOffset, System::DynamicArray<System::Byte> &aBytes);
	int __fastcall GetRequiredBytes(int aValue, System::Byte aByte, int aNumBits);
	int __fastcall DoEncodeStringInto(System::DynamicArray<System::Byte> aBytes, const System::UnicodeString aValue, int aLength, int aOffset, TsgcHPackHuffmanStrategy aHuffman);
	System::DynamicArray<System::Byte> __fastcall DoEncodeString(const System::UnicodeString aValue, TsgcHPackHuffmanStrategy aHuffman);
	
protected:
	virtual System::DynamicArray<System::Byte> __fastcall EncodeInteger(int aValue, System::Byte aByte, int aNumBits);
	virtual System::DynamicArray<System::Byte> __fastcall EncodeString(const System::UnicodeString aValue, TsgcHPackHuffmanStrategy aHuffman);
	
public:
	void __fastcall Encode(System::DynamicArray<System::Byte> aBuffer, int aOffset, TsgcHTTP2_TableEntry* *aHeaders, const int aHeaders_High, int &UsedBytes, int &FieldCount);
...
private:
	...
	System::DynamicArray<System::Byte> FDecodeStrBuffer;
	...
	int __fastcall DoDecodeIntCont(System::DynamicArray<System::Byte> aBytes, int aOffset);
	int __fastcall DoDecodeInteger(int aPrefixLength, System::DynamicArray<System::Byte> aBytes, int aOffset = 0x0);
	int __fastcall DoDecodeStringCont(System::DynamicArray<System::Byte> aBytes, int aOffset);
	int __fastcall DoDecodeStringContLength(System::DynamicArray<System::Byte> aBytes, int aOffset);
	int __fastcall DoDecodeStringByteData(System::DynamicArray<System::Byte> aBytes, int aOffset);
	int __fastcall DoDecodeString(System::DynamicArray<System::Byte> aBytes, int aOffset);
	
protected:
	virtual int __fastcall DecodeInteger(int aPrefixLength, System::DynamicArray<System::Byte> aBytes, int aOffset = 0x0);
	virtual int __fastcall DecodeString(System::DynamicArray<System::Byte> aBytes, int aOffset = 0x0);
...
public:
	int __fastcall Decode(System::DynamicArray<System::Byte> aBuffer, int aOffset = 0x0)/* overload */;
	void __fastcall Decode(System::DynamicArray<System::Byte> aBuffer, int aOffset, int aLength, System::Classes::TStringList* &aHeaders)/* overload */;
	int __fastcall DoHandleStartOfPacket(System::DynamicArray<System::Byte> aBuffer, int aOffset = 0x0);
	int __fastcall DoExecutePendingTask(System::DynamicArray<System::Byte> aBuffer, int aOffset, bool &aExecuteMoreTaks);
