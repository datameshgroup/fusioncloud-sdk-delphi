...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket.pas' rev: 34.00 (Windows)
...
class DELPHICLASS TsgcWebSocketServer_HTTPAPI;
//-- type declarations -------------------------------------------------------
...
class PASCALIMPLEMENTATION TsgcWebSocketServer_HTTPAPI : public Sgcwebsocket_server_httpapi::TsgcWSServer_HTTPAPI
{
	typedef Sgcwebsocket_server_httpapi::TsgcWSServer_HTTPAPI inherited;
...
__published:
	...
	__property Timeouts;
	__property Asynchronous;
	__property BindingOptions;
	__property MaxConnections;
	__property MaxBandwidth;
	__property ThreadPoolSize;
	__property ReadBufferSize;
	__property HTTPUploadFiles;
	__property Version = {default=0};
public:
	/* TsgcWSServer_HTTPAPI.Create */ inline __fastcall virtual TsgcWebSocketServer_HTTPAPI(System::Classes::TComponent* aOwner) : Sgcwebsocket_server_httpapi::TsgcWSServer_HTTPAPI(aOwner) { }
	/* TsgcWSServer_HTTPAPI.Destroy */ inline __fastcall virtual ~TsgcWebSocketServer_HTTPAPI() { }
