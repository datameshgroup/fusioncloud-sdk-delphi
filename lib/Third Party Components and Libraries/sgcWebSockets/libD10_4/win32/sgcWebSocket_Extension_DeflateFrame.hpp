...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Extension_DeflateFrame.pas' rev: 34.00 (Windows)
...
protected:
	...
	int __fastcall IdRead(z_stream &aStrmRec, Sgcidglobal::TIdBytes &VBuffer, int AOffset);
