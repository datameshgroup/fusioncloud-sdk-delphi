...
// (DO NOT EDIT: machine generated header) 'sgcTCP_Client.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TsgcTCPOnSSLGetHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdSSLIOHandlerSocketBase* &aSSLHandler);

typedef void __fastcall (__closure *TsgcTCPOnSSLAfterCreateHandler)(System::TObject* Sender, Sgcwebsocket_types::TwsSSLHandler aType, Sgcidssl::TIdSSLIOHandlerSocketBase* aSSLHandler);
...
private:
	...
	void __fastcall SetBytes(const Sgcidglobal::TIdBytes Value);
	
public:
	__fastcall virtual TsgcQueueCommand();
	__fastcall virtual ~TsgcQueueCommand();
	__property Sgcidglobal::TIdBytes Bytes = {read=FBytes, write=SetBytes};
...
public:
	...
	void __fastcall AddBytes(const Sgcidglobal::TIdBytes ABytes);
public:
...
class PASCALIMPLEMENTATION TsgcIdTCPClient : public Sgcidtcpclient::TIdTCPClient
{
	typedef Sgcidtcpclient::TIdTCPClient inherited;
...
__published:
	...
	__property TsgcReadThreadExceptionEvent OnReadException = {read=FOnReadException, write=FOnReadException};
public:
	/* TIdBaseComponent.Create */ inline __fastcall TsgcIdTCPClient(System::Classes::TComponent* AOwner)/* overload */ : Sgcidtcpclient::TIdTCPClient(AOwner) { }
	
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TsgcIdTCPClient()/* overload */ : Sgcidtcpclient::TIdTCPClient() { }
	
	/* Hoisted overloads: */
	
public:
	inline void __fastcall  Connect(const System::UnicodeString AHost){ Sgcidtcpclient::TIdTCPClientCustom::Connect(AHost); }
	inline void __fastcall  Connect(const System::UnicodeString AHost, const System::Word APort){ Sgcidtcpclient::TIdTCPClientCustom::Connect(AHost, APort); }
	inline void __fastcall  Disconnect(){ Sgcidtcpconnection::TIdTCPConnection::Disconnect(); }
	
};


class PASCALIMPLEMENTATION TsgcIdSSLIOHandlerSocketOpenSSL : public Sgcidsslopenssl::TIdSSLIOHandlerSocketOpenSSL
{
	typedef Sgcidsslopenssl::TIdSSLIOHandlerSocketOpenSSL inherited;
...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TsgcIdSSLIOHandlerSocketOpenSSL(System::Classes::TComponent* AOwner)/* overload */ : Sgcidsslopenssl::TIdSSLIOHandlerSocketOpenSSL(AOwner) { }
	
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TsgcIdSSLIOHandlerSocketOpenSSL()/* overload */ : Sgcidsslopenssl::TIdSSLIOHandlerSocketOpenSSL() { }
...
protected:
	virtual void __fastcall DoInitialize(Sgcidtcpconnection::TIdTCPConnection* aConnection);
...
protected:
	...
	virtual void __fastcall OnClientStatusEvent(System::TObject* ASender, const Sgcidcomponent::TIdStatus AStatus, const System::UnicodeString AStatusText);
...
private:
	Sgcidinterceptthrottler::TIdInterceptThrottler* FInterceptThrottle;
	Sgcidinterceptthrottler::TIdInterceptThrottler* __fastcall GetInterceptThrottle();
	
protected:
	__property Sgcidinterceptthrottler::TIdInterceptThrottler* InterceptThrottle = {read=GetInterceptThrottle, write=FInterceptThrottle};
	Sgcidintercept::TIdConnectionIntercept* __fastcall GetConnectionIntercept();
...
private:
	...
	Sgcidiohandlerstack::TIdIOHandlerStack* __fastcall GetProxyIOHandler();
...
private:
	Sgcidssl::TIdSSLIOHandlerSocketBase* FHandlerSSL;
	
protected:
	TsgcTCPOnSSLGetHandler FOnSSLGetHandler;
	TsgcTCPOnSSLAfterCreateHandler FOnSSLAfterCreateHandler;
	__property Sgcidssl::TIdSSLIOHandlerSocketBase* HandlerSSL = {read=FHandlerSSL};
	virtual void __fastcall GetHandlerSSLEvent(const Sgcwebsocket_types::TwsSSLHandler aSSLType, Sgcidssl::TIdSSLIOHandlerSocketBase* &aSSLHandler);
