...
// (DO NOT EDIT: machine generated header) 'sgcHTTP2_Client.pas' rev: 34.00 (Windows)
...
protected:
	void __fastcall DoDeflate(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoGZIP(const System::DynamicArray<System::Byte> aBytes);
	
public:
	__fastcall virtual ~TsgcHTTP2ResponseProperty();
	
protected:
	void __fastcall SetData(const System::DynamicArray<System::Byte> aData);
...
public:
	__property System::DynamicArray<System::Byte> Bytes = {read=FBytes, write=FBytes};
	__property System::UnicodeString DataString = {read=GetDataString};
public:
...
typedef System::DynamicArray<System::Byte> _dt_Sgchttp2_client_1;
typedef void __fastcall (__closure *TsgcHTTP2ClientStreamResponseFragmentEvent)(System::TObject* Sender, TsgcHTTP2ConnectionClient* const Connection, Sgchttp2_frame::TsgcHTTP2_StreamResponse* const Stream, const _dt_Sgchttp2_client_1 Bytes);
...
private:
	...
	void __fastcall OnInternalReadWriteBytes(System::TObject* Sender, const System::DynamicArray<System::Byte> aBytes);
...
protected:
	...
	virtual void __fastcall OnReadStreamResponseFragmentEvent(System::TObject* Sender, Sgchttp2_frame::TsgcHTTP2_StreamResponse* const aResponse, const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoReadFrame(const System::DynamicArray<System::Byte> aBytes);
...
protected:
	...
	virtual void __fastcall DoNotifyHTTP2ResponseFragment(TsgcHTTP2ConnectionClient* const aConnection, Sgchttp2_frame::TsgcHTTP2_StreamResponse* const aStream, const System::DynamicArray<System::Byte> aBytes);
	...
	virtual void __fastcall DoEventHTTP2ResponseFragment(TsgcHTTP2ConnectionClient* const aConnection, Sgchttp2_frame::TsgcHTTP2_StreamResponse* const aStream, const System::DynamicArray<System::Byte> aBytes);
	...
	virtual void __fastcall OnHTTP2StreamResponseFragmentEvent(System::TObject* Sender, TsgcHTTP2ConnectionClient* const Connection, Sgchttp2_frame::TsgcHTTP2_StreamResponse* const Stream, const System::DynamicArray<System::Byte> Bytes);
