...
// (DO NOT EDIT: machine generated header) 'sgcP2P_STUN_Types.pas' rev: 34.00 (Windows)
...
enum DECLSPEC_DENUM TsgcStunErrorResponseCodes : unsigned char { sercInvalidRequest, sercUnauthorized, sercUnknownAttribute, sercStaleNonce, sercTryAlternate, sercForbidden, sercAllocationMismatch, sercAddressFamilyNotSupported, sercWrongCredentials, sercUnsupportedTransportProtocol, sercPeerAddressFamilyMismatch, sercAllocationQuotaReached, sercInsufficientCapacity };
