...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Classes.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef System::TMetaClass* TsgcWS_ProtocolClass;
...
protected:
	...
	virtual void __fastcall DoReadBytes(Sgcidglobal::TIdBytes &aBuffer, int aCount) = 0 ;
	virtual void __fastcall DoWriteBytes(Sgcidglobal::TIdBytes aBuffer) = 0 ;
