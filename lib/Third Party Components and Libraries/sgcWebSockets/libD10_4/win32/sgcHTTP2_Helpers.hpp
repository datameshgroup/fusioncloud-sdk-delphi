...
// (DO NOT EDIT: machine generated header) 'sgcHTTP2_Helpers.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE int __fastcall GetIntegerFromBytes(const System::DynamicArray<System::Byte> aBytes, int aLength, int aOffset = 0x0);
extern DELPHI_PACKAGE void __fastcall SetBytesFromInteger(int aValue, int aOffset, int aNumBytes, System::DynamicArray<System::Byte> &aBytes);
extern DELPHI_PACKAGE System::DynamicArray<System::Byte> __fastcall GetBytesFromString(const System::AnsiString aText);
