...
// (DO NOT EDIT: machine generated header) 'sgcIdZLib.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TCustomZlibStream : public Sgcidglobal::TIdBaseStream
{
...
protected:
	...
	gz_header FGZHeader;
	Sgcidzlibheaders::TZStreamType FStreamType;
...
public:
	__fastcall TCompressionStream(TCompressionLevel CompressionLevel, System::Classes::TStream* Dest, const Sgcidzlibheaders::TZStreamType StreamType, const System::UnicodeString AName, int ATime);
...
extern DELPHI_PACKAGE Sgcidzlibheaders::TZStreamType __fastcall GetStreamType(void * InBuffer, unsigned InCount, gz_headerp gzheader, /* out */ unsigned &HeaderSize)/* overload */;
extern DELPHI_PACKAGE Sgcidzlibheaders::TZStreamType __fastcall GetStreamType(System::Classes::TStream* InStream, gz_headerp gzheader, /* out */ unsigned &HeaderSize)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall CompressStream(System::Classes::TStream* InStream, System::Classes::TStream* OutStream, TCompressionLevel level, Sgcidzlibheaders::TZStreamType StreamType);
extern DELPHI_PACKAGE void __fastcall CompressStreamEx(System::Classes::TStream* InStream, System::Classes::TStream* OutStream, TCompressionLevel level, Sgcidzlibheaders::TZStreamType StreamType);
extern DELPHI_PACKAGE System::UnicodeString __fastcall CompressString(const System::UnicodeString InString, TCompressionLevel level, Sgcidzlibheaders::TZStreamType StreamType);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDZLIB)
using namespace Sgcidzlib;
#endif
#pragma pack(pop)
#pragma option pop
