...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_API_Kraken.pas' rev: 34.00 (Android)
...
public:
	...
	System::UnicodeString __fastcall GetTradesHistory(const System::UnicodeString aType = u"all", const bool aTrades = false, const System::UnicodeString aStart = System::UnicodeString(), const System::UnicodeString aEnd = System::UnicodeString(), const System::UnicodeString aOfs = System::UnicodeString());
	...
	System::UnicodeString __fastcall AddExport(const System::UnicodeString aDescription, const System::UnicodeString aReport = u"trades", const System::UnicodeString aFormat = u"CSV", const System::UnicodeString aFields = u"all", const System::UnicodeString aAsset = u"all", const System::UnicodeString aStartTm = System::UnicodeString(), const System::UnicodeString aEndTm = System::UnicodeString());
	System::UnicodeString __fastcall ExportStatus(const System::UnicodeString aReport = u"trades");
	System::UnicodeString __fastcall RetrieveExport(const System::UnicodeString aId);
	System::UnicodeString __fastcall RemoveExport(const System::UnicodeString aId, const System::UnicodeString aType = u"delete");
...
public:
	...
	System::UnicodeString __fastcall GetHistoricalOrders(System::TDateTime aSince, System::TDateTime aBefore = 0.000000E+00, System::UnicodeString aSort = u"desc", System::UnicodeString aContinuationToken = System::UnicodeString());
	System::UnicodeString __fastcall GetHistoricalTriggers(System::TDateTime aSince, System::TDateTime aBefore = 0.000000E+00, System::UnicodeString aSort = u"desc", System::UnicodeString aContinuationToken = System::UnicodeString());
	System::UnicodeString __fastcall GetHistoricalExecutions(System::TDateTime aSince, System::TDateTime aBefore = 0.000000E+00, System::UnicodeString aSort = u"desc", System::UnicodeString aContinuationToken = System::UnicodeString());
