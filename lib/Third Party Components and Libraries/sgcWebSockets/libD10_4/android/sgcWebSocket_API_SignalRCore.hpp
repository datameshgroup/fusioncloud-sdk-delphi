...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_API_SignalRCore.pas' rev: 34.00 (Android)
...
protected:
	...
	virtual void __fastcall DoInvoke(const System::UnicodeString aTarget, const System::UnicodeString aArguments = u"[]", const System::UnicodeString aInvocationId = System::UnicodeString());
	...
	virtual void __fastcall DoInvokeStream(const System::UnicodeString aTarget, const System::UnicodeString aArguments = u"[]", const System::UnicodeString aInvocationId = u"0");
