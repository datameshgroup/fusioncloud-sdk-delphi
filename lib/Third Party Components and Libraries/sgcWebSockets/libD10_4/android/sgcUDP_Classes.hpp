...
// (DO NOT EDIT: machine generated header) 'sgcUDP_Classes.pas' rev: 34.00 (Android)
...
typedef void __fastcall (__closure *TsgcUDPRetransmissionRetryEvent)(System::TObject* Sender, const System::TArray__1<System::Byte> Bytes, const System::UnicodeString aIPAddress, System::Word aPort);
...
private:
	...
	int FRetries;
	int FRTO;
	void __fastcall SetBytes(const System::TArray__1<System::Byte> Value);
	
public:
	__fastcall virtual TsgcUDPRetransmissionItem();
	__property System::TArray__1<System::Byte> Bytes = {read=FBytes, write=SetBytes};
...
protected:
	System::TArray__1<System::Byte> FUDPEndOfFrame;
...
protected:
	...
	virtual void __fastcall DoLogData(const System::TArray__1<System::Byte> aBuffer);
	
public:
	void __fastcall LogData(const System::TArray__1<System::Byte> aBuffer);
...
protected:
	System::TArray__1<System::Byte> FMsgRead;
	
public:
	__property System::TArray__1<System::Byte> MsgRead = {read=FMsgRead, write=FMsgRead};
...
public:
	...
	void __fastcall AddNotifyObject(TsgcUDPSocket* aSocket, System::TArray__1<System::Byte> aBytes)/* overload */;
...
protected:
	...
	virtual void __fastcall DoEventUDPRead(TsgcUDPSocket* const aSocket, const System::TArray__1<System::Byte> Bytes);
