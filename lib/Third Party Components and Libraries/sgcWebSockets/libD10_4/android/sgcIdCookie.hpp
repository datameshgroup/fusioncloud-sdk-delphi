...
// (DO NOT EDIT: machine generated header) 'sgcIdCookie.pas' rev: 34.00 (Android)

#ifndef SgcidcookieHPP
#define SgcidcookieHPP
...
private:
	System::UnicodeString FSameSite;
...
public:
	...
	virtual bool __fastcall IsAllowed(Sgciduri::TIdURI* AURI, bool SecureOnly);
	virtual bool __fastcall ParseClientCookie(const System::UnicodeString ACookieText);
	virtual bool __fastcall ParseServerCookie(const System::UnicodeString ACookieText, Sgciduri::TIdURI* AURI);
	...
	__property System::UnicodeString SameSite = {read=FSameSite, write=FSameSite};
};
...
protected:
	...
	System::Sysutils::TSimpleRWSync* FRWLock;
...
public:
	...
	bool __fastcall AddCookie(TIdCookie* ACookie, Sgciduri::TIdURI* AURI, bool AReplaceOld = true);
	...
	TIdCookie* __fastcall AddServerCookie(const System::UnicodeString ACookie, Sgciduri::TIdURI* AURI);
	void __fastcall AddServerCookies(System::Classes::TStrings* const ACookies, Sgciduri::TIdURI* AURI);
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION EIdCookieError : public Sgcidexception::EIdException
{
	typedef Sgcidexception::EIdException inherited;
	
public:
	/* EIdException.Create */ inline __fastcall virtual EIdCookieError(const System::UnicodeString AMsg)/* overload */ : Sgcidexception::EIdException(AMsg) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EIdCookieError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Sgcidexception::EIdException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EIdCookieError(NativeUInt Ident)/* overload */ : Sgcidexception::EIdException(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EIdCookieError(System::PResStringRec ResStringRec)/* overload */ : Sgcidexception::EIdException(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdCookieError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Sgcidexception::EIdException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdCookieError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Sgcidexception::EIdException(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EIdCookieError(const System::UnicodeString Msg, int AHelpContext) : Sgcidexception::EIdException(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EIdCookieError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Sgcidexception::EIdException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdCookieError(NativeUInt Ident, int AHelpContext)/* overload */ : Sgcidexception::EIdException(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdCookieError(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Sgcidexception::EIdException(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdCookieError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Sgcidexception::EIdException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdCookieError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Sgcidexception::EIdException(Ident, Args, Args_High, AHelpContext) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDCOOKIE)
using namespace Sgcidcookie;
#endif
#pragma pack(pop)
#pragma option pop
