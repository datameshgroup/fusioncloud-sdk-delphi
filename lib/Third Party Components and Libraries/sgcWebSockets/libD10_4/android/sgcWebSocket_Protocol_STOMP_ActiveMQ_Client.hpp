...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Protocol_STOMP_ActiveMQ_Client.pas' rev: 34.00 (Android)
...
public:
	...
	void __fastcall PublishEx(const System::UnicodeString aDestination, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString(), TsgcWSActiveMQSTOMP_Message_Options* const aOptions = (TsgcWSActiveMQSTOMP_Message_Options*)(0x0));
	...
	void __fastcall PublishTopic(const System::UnicodeString aTopic, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString(), TsgcWSActiveMQSTOMP_Message_Options* const aOptions = (TsgcWSActiveMQSTOMP_Message_Options*)(0x0));
	...
	void __fastcall PublishQueue(const System::UnicodeString aQueue, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString(), TsgcWSActiveMQSTOMP_Message_Options* const aOptions = (TsgcWSActiveMQSTOMP_Message_Options*)(0x0));
