...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Types.pas' rev: 34.00 (Android)
...
enum DECLSPEC_DENUM TwsSocketIOAPI : unsigned char { ioAPI0, ioAPI1, ioAPI2, ioAPI3 };
...
enum DECLSPEC_DENUM TwsOpenSSLLibPath : unsigned char { oslpNone, oslpDefaultFolder };
