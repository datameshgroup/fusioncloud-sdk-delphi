...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_Google_PubSub.pas' rev: 34.00 (Android)
...
public:
	...
	System::UnicodeString __fastcall CreateSubscription(const System::UnicodeString aProject, const System::UnicodeString aSubscription, const System::UnicodeString aTopic, const System::UnicodeString aPushEndPoint = System::UnicodeString(), int aAckDeadlineSeconds = 0x0, bool aRetainAckedMessages = false, System::UnicodeString aMessageRetentionDuration = u"604800s", System::Classes::TStrings* const aLabels = (System::Classes::TStrings*)(0x0), System::UnicodeString aExpirationPolicy = u"2678400s");
