...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_Google_Calendar.pas' rev: 34.00 (Android)
...
public:
	...
	System::UnicodeString __fastcall Event_Delete(const System::UnicodeString aCalendarId, const System::UnicodeString aEventId, bool aSendNotifications = false, const System::UnicodeString aSendUpdates = u"all");
	...
	System::UnicodeString __fastcall Event_Insert(const System::UnicodeString aCalendarId, TsgcGoogleCalendarResource_Event* const aResource, int aConferenceDataVersion = 0x0, int aMaxAttendees = 0x0, const System::UnicodeString aSendUpdates = u"all", bool aSupportsAttachments = false);
	...
	System::UnicodeString __fastcall Event_Move(const System::UnicodeString aCalendarId, const System::UnicodeString aEventId, const System::UnicodeString aDestination, const System::UnicodeString aSendUpdates = u"all");
	System::UnicodeString __fastcall Event_Patch(const System::UnicodeString aCalendarId, const System::UnicodeString aEventId, TsgcGoogleCalendarResource_Event* const aResource, int aConferenceDataVersion = 0x0, int aMaxAttendees = 0x0, const System::UnicodeString aSendUpdates = u"all", bool aSupportsAttachments = false);
	System::UnicodeString __fastcall Event_QuickAdd(const System::UnicodeString aCalendarId, const System::UnicodeString aText, const System::UnicodeString aSendUpdates = u"all");
	System::UnicodeString __fastcall Event_Update(const System::UnicodeString aCalendarId, const System::UnicodeString aEventId, TsgcGoogleCalendarResource_Event* const aResource, int aConferenceDataVersion = 0x0, int aMaxAttendees = 0x0, const System::UnicodeString aSendUpdates = u"all", bool aSupportsAttachments = false);
