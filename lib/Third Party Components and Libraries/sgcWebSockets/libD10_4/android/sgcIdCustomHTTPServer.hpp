...
// (DO NOT EDIT: machine generated header) 'sgcIdCustomHTTPServer.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr bool Id_TId_HTTPServer_KeepAlive = false;
static constexpr bool Id_TId_HTTPServer_ParseParams = true;
static constexpr bool Id_TId_HTTPServer_SessionState = false;
static constexpr System::Int8 Id_TId_HTTPSessionTimeOut = System::Int8(0x0);
static constexpr bool Id_TId_HTTPAutoStartSession = false;
static constexpr System::Word Id_TId_HTTPMaximumHeaderLineCount = System::Word(0x400);
static constexpr System::Byte GResponseNo = System::Byte(0xc8);
static constexpr System::Int8 GFContentLength = System::Int8(-1);
