...
// (DO NOT EDIT: machine generated header) 'sgcUDP_Classes_Indy.pas' rev: 34.00 (Android)
...
private:
	Sgcidsockethandle::TIdSocketHandle* FSocket;
	
protected:
	__property Sgcidsockethandle::TIdSocketHandle* Socket = {read=FSocket, write=FSocket};
