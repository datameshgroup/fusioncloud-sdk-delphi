...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_JWT_ES.pas' rev: 34.00 (Android)
...
private:
	System::TArray__1<System::Byte> __fastcall DoConvertRS(void * aSignature, Sgchttp_jwt_types::TsgcHTTP_JWT_Algorithm aAlgorithm);
	void * __fastcall DoSignatureRS(const System::TArray__1<System::Byte> aSignature);
	void * __fastcall LoadPublicKey(const System::UnicodeString aValue);
	
public:
	System::TArray__1<System::Byte> __fastcall SignES256(System::TArray__1<System::Byte> aValue, System::TArray__1<System::Byte> aKey);
	System::TArray__1<System::Byte> __fastcall SignES384(System::TArray__1<System::Byte> aValue, System::TArray__1<System::Byte> aKey);
	System::TArray__1<System::Byte> __fastcall SignES512(System::TArray__1<System::Byte> aValue, System::TArray__1<System::Byte> aKey);
	
protected:
	virtual void __fastcall DoLoadOpenSSLMethods();
	virtual System::TArray__1<System::Byte> __fastcall DoSignES(System::TArray__1<System::Byte> aValue, System::TArray__1<System::Byte> aKey, Sgchttp_jwt_types::TsgcHTTP_JWT_Algorithm aAlgorithm);
