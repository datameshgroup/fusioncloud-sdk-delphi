...
// (DO NOT EDIT: machine generated header) 'sgcIdSSLOpenSSLHeaders.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word TLS1_3_VERSION = System::Word(0x304);
static constexpr System::Int8 TLS1_3_VERSION_MAJOR = System::Int8(0x3);
static constexpr System::Int8 TLS1_3_VERSION_MINOR = System::Int8(0x4);
static constexpr int OPENSSL_VER_1100 = int(0x1010000f);
static constexpr int OPENSSL_VER_1101 = int(0x1010100f);
extern DELPHI_PACKAGE TOpenSSLApi OPENSSL_API_VERSION;
extern DELPHI_PACKAGE unsigned OPENSSL_DLL_VERSION;
