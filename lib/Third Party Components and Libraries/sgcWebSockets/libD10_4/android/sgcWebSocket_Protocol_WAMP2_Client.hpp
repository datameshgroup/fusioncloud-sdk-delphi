...
public:
	void __fastcall Subscribe(const System::UnicodeString aTopic, const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = 0LL);
	...
	void __fastcall Publish(const System::UnicodeString aTopic, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = 0LL);
	void __fastcall Call(const System::UnicodeString aProcedure, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = 0LL);
	void __fastcall RegisterCall(const System::UnicodeString aProcedure, const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = 0LL);
	...
	void __fastcall Yield(const System::UnicodeString aOptions = u"{}", const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const __int64 aRequestId = 0LL);
