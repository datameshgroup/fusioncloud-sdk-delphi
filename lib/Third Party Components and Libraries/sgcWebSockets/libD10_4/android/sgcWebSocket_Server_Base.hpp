...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Server_Base.pas' rev: 34.00 (Android)
...
private:
	Sgchttp_oauth2_server::TsgcHTTPComponentServer_OAuth2* FOAuth2;
	
public:
	__fastcall virtual TsgcWSAuthenticationServer_OAuth();
	
__published:
	__property Sgchttp_oauth2_server::TsgcHTTPComponentServer_OAuth2* OAuth2 = {read=FOAuth2, write=FOAuth2};
public:
...
private:
	Sgchttp_jwt_server::TsgcHTTPComponentServer_JWT* FJWT;
	
public:
	__fastcall virtual TsgcWSAuthenticationServer_JWT();
	
__published:
	__property Sgchttp_jwt_server::TsgcHTTPComponentServer_JWT* JWT = {read=FJWT, write=FJWT};
public:
