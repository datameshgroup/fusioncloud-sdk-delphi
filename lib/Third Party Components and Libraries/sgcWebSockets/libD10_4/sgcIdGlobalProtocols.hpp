...
// (DO NOT EDIT: machine generated header) 'sgcIdGlobalProtocols.pas' rev: 34.00 (Windows)

#ifndef SgcidglobalprotocolsHPP
#define SgcidglobalprotocolsHPP
...
namespace Sgcidglobalprotocols
{
...
//-- type declarations -------------------------------------------------------
typedef System::StaticArray<System::UnicodeString, 7> Sgcidglobalprotocols__1;

typedef System::StaticArray<System::UnicodeString, 12> Sgcidglobalprotocols__2;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION EIdExtensionAlreadyExists : public Sgcidexception::EIdException
{
	typedef Sgcidexception::EIdException inherited;
	
public:
	/* EIdException.Create */ inline __fastcall virtual EIdExtensionAlreadyExists(const System::UnicodeString AMsg)/* overload */ : Sgcidexception::EIdException(AMsg) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EIdExtensionAlreadyExists(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Sgcidexception::EIdException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EIdExtensionAlreadyExists(NativeUInt Ident)/* overload */ : Sgcidexception::EIdException(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EIdExtensionAlreadyExists(System::PResStringRec ResStringRec)/* overload */ : Sgcidexception::EIdException(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdExtensionAlreadyExists(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Sgcidexception::EIdException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdExtensionAlreadyExists(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Sgcidexception::EIdException(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EIdExtensionAlreadyExists(const System::UnicodeString Msg, int AHelpContext) : Sgcidexception::EIdException(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EIdExtensionAlreadyExists(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Sgcidexception::EIdException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdExtensionAlreadyExists(NativeUInt Ident, int AHelpContext)/* overload */ : Sgcidexception::EIdException(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdExtensionAlreadyExists(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Sgcidexception::EIdException(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdExtensionAlreadyExists(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Sgcidexception::EIdException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdExtensionAlreadyExists(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Sgcidexception::EIdException(Ident, Args, Args_High, AHelpContext) { }
...
typedef Sgcidglobal::_di_IIdTextEncoding __fastcall (*TIdEncodingNeededEvent)(const System::UnicodeString ACharset);

typedef System::DynamicArray<System::UnicodeString> Sgcidglobalprotocols__6;

typedef System::DynamicArray<System::UnicodeString> Sgcidglobalprotocols__7;

//-- var, const, procedure ---------------------------------------------------
#define LWS L"\t "
extern DELPHI_PACKAGE Sgcidglobalprotocols__1 wdays;
extern DELPHI_PACKAGE Sgcidglobalprotocols__2 monthnames;
extern DELPHI_PACKAGE TIdEncodingNeededEvent GIdEncodingNeeded;
extern DELPHI_PACKAGE Sgcidglobalprotocols__6 IndyFalseBoolStrs;
extern DELPHI_PACKAGE Sgcidglobalprotocols__7 IndyTrueBoolStrs;
extern DELPHI_PACKAGE System::TDateTime UNIXSTARTDATE;
static const System::Int8 TIME_BASEDATE = System::Int8(0x2);
...
extern DELPHI_PACKAGE void __fastcall CopyBytesToHostWord _DEPRECATED_ATTRIBUTE1("Use CopyBytesToHostWord") (const Sgcidglobal::TIdBytes ASource, const int ASourceIndex, System::Word &VDest);
extern DELPHI_PACKAGE void __fastcall CopyBytesToHostUInt16(const Sgcidglobal::TIdBytes ASource, const int ASourceIndex, System::Word &VDest);
extern DELPHI_PACKAGE void __fastcall CopyBytesToHostLongWord _DEPRECATED_ATTRIBUTE1("Use CopyBytesToHostUInt32") (const Sgcidglobal::TIdBytes ASource, const int ASourceIndex, unsigned &VDest);
extern DELPHI_PACKAGE void __fastcall CopyBytesToHostUInt32(const Sgcidglobal::TIdBytes ASource, const int ASourceIndex, unsigned &VDest);
extern DELPHI_PACKAGE void __fastcall CopyTIdNetworkWord _DEPRECATED_ATTRIBUTE1("Use CopyTIdNetworkWord") (const System::Word ASource, Sgcidglobal::TIdBytes &VDest, const int ADestIndex);
extern DELPHI_PACKAGE void __fastcall CopyTIdNetworkUInt16(const System::Word ASource, Sgcidglobal::TIdBytes &VDest, const int ADestIndex);
extern DELPHI_PACKAGE void __fastcall CopyTIdNetworkLongWord _DEPRECATED_ATTRIBUTE1("Use CopyTIdNetworkLongWord") (const unsigned ASource, Sgcidglobal::TIdBytes &VDest, const int ADestIndex);
extern DELPHI_PACKAGE void __fastcall CopyTIdNetworkUInt32(const unsigned ASource, Sgcidglobal::TIdBytes &VDest, const int ADestIndex);
...
extern DELPHI_PACKAGE void __fastcall UInt16ToTwoBytes(System::Word AWord, Sgcidglobal::TIdBytes ByteArray, int Index);
extern DELPHI_PACKAGE void __fastcall WordToTwoBytes _DEPRECATED_ATTRIBUTE1("Use UInt16ToTwoBytes()") (System::Word AWord, Sgcidglobal::TIdBytes ByteArray, int Index);
...
extern DELPHI_PACKAGE bool __fastcall IsVolume(const System::UnicodeString APathName);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall ProcessPath(const System::UnicodeString ABasePath, const System::UnicodeString APath, const System::UnicodeString APathDelim = L"/");
...
extern DELPHI_PACKAGE Sgcidcharsets::TIdCharSet __fastcall IdGetDefaultCharSet(void);
...
extern DELPHI_PACKAGE Sgcidglobal::_di_IIdTextEncoding __fastcall ContentTypeToEncoding(const System::UnicodeString AContentType, TIdHeaderQuotingType AQuoteType);
extern DELPHI_PACKAGE Sgcidglobal::_di_IIdTextEncoding __fastcall CharsetToEncoding(const System::UnicodeString ACharset);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDGLOBALPROTOCOLS)
using namespace Sgcidglobalprotocols;
#endif
#pragma pack(pop)
#pragma option pop
