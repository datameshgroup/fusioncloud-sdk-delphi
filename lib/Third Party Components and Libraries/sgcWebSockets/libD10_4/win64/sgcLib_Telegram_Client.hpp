...
// (DO NOT EDIT: machine generated header) 'sgcLib_Telegram_Client.pas' rev: 34.00 (Windows)
...
public:
	void __fastcall SendTextMessage(const System::UnicodeString aChatId, const System::UnicodeString aText, TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0));
	void __fastcall SendRichTextMessage(const System::UnicodeString aChatId, const System::UnicodeString aText, TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0));
	void __fastcall SendDocumentMessage(const System::UnicodeString aChatId, const System::UnicodeString aFilePath, TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0));
	void __fastcall SendPhotoMessage(const System::UnicodeString aChatId, const System::UnicodeString aFilePath, int aWidth = 0x0, int aHeight = 0x0, TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0));
	void __fastcall SendVideoMessage(const System::UnicodeString aChatId, const System::UnicodeString aFilePath, int aWidth = 0x0, int aHeight = 0x0, __int64 aDuration = (__int64)(0LL), TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0));
