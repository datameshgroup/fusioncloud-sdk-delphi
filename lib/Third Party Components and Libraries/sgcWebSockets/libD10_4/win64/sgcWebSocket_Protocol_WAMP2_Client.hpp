...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Protocol_WAMP2_Client.pas' rev: 34.00 (Windows)
...
public:
	void __fastcall Subscribe(const System::UnicodeString aTopic, const System::UnicodeString aOptions = L"{}", const __int64 aRequestId = (__int64)(0LL));
	...
	void __fastcall Publish(const System::UnicodeString aTopic, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = L"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall Call(const System::UnicodeString aProcedure, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = L"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall RegisterCall(const System::UnicodeString aProcedure, const System::UnicodeString aOptions = L"{}", const __int64 aRequestId = (__int64)(0LL));
	...
	void __fastcall Yield(const System::UnicodeString aOptions = L"{}", const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const __int64 aRequestId = (__int64)(0LL));
