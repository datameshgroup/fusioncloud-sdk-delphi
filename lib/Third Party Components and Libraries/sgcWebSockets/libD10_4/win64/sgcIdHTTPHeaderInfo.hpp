...
// (DO NOT EDIT: machine generated header) 'sgcIdHTTPHeaderInfo.pas' rev: 34.00 (Windows)

#ifndef SgcidhttpheaderinfoHPP
#define SgcidhttpheaderinfoHPP
...
protected:
	...
	Sgcidheaderlist::TIdHeaderList* FRawHeaders;
	...
	Sgcidheaderlist::TIdHeaderList* FCustomHeaders;
	...
	void __fastcall SetCustomHeaders(Sgcidheaderlist::TIdHeaderList* const AValue);
...
public:
	...
	__property Sgcidheaderlist::TIdHeaderList* RawHeaders = {read=FRawHeaders};
...
__published:
	...
	__property Sgcidheaderlist::TIdHeaderList* CustomHeaders = {read=FCustomHeaders, write=SetCustomHeaders};
...
protected:
	Sgcidauthentication::TIdAuthentication* FAuthentication;
...
public:
	...
	void __fastcall SetHeaders(Sgcidheaderlist::TIdHeaderList* Headers);
	__property Sgcidauthentication::TIdAuthentication* Authentication = {read=FAuthentication, write=FAuthentication};
...
protected:
	...
	System::UnicodeString FServer;
	System::UnicodeString FProxyConnection;
	Sgcidheaderlist::TIdHeaderList* FProxyAuthenticate;
	Sgcidheaderlist::TIdHeaderList* FWWWAuthenticate;
	void __fastcall SetProxyAuthenticate(Sgcidheaderlist::TIdHeaderList* const Value);
	void __fastcall SetWWWAuthenticate(Sgcidheaderlist::TIdHeaderList* const Value);
...
__published:
	...
	__property System::UnicodeString ProxyConnection = {read=FProxyConnection, write=FProxyConnection};
	__property Sgcidheaderlist::TIdHeaderList* ProxyAuthenticate = {read=FProxyAuthenticate, write=SetProxyAuthenticate};
	__property System::UnicodeString Server = {read=FServer, write=FServer};
	__property Sgcidheaderlist::TIdHeaderList* WWWAuthenticate = {read=FWWWAuthenticate, write=SetWWWAuthenticate};
};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDHTTPHEADERINFO)
using namespace Sgcidhttpheaderinfo;
#endif
#pragma pack(pop)
#pragma option pop
