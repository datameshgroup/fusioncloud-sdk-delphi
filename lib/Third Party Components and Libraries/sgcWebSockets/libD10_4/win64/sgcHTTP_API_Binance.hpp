...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_API_Binance.pas' rev: 34.00 (Windows)
...
public:
	...
	System::UnicodeString __fastcall GetAggregateTrades(const System::UnicodeString aSymbol, int aFromId = 0x0, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x1f4);
	System::UnicodeString __fastcall GetKLines(const System::UnicodeString aSymbol, TsgcHTTPBinanceChartIntervals aInterval, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x1f4);
...
public:
	...
	System::UnicodeString __fastcall QueryOrder(const System::UnicodeString aSymbol, __int64 aOrderId = (__int64)(0LL), const System::UnicodeString aOrigClientOrderId = System::UnicodeString());
	System::UnicodeString __fastcall CancelOrder(const System::UnicodeString aSymbol, __int64 aOrderId = (__int64)(0LL), const System::UnicodeString aOrigClientOrderId = System::UnicodeString());
	...
	System::UnicodeString __fastcall GetAllOrders(const System::UnicodeString aSymbol, __int64 aOrderId = (__int64)(0LL), __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x1f4);
	...
	System::UnicodeString __fastcall GetAllOCO(int aFromId = 0x0, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x1f4);
	System::UnicodeString __fastcall GetOpenOCO();
	System::UnicodeString __fastcall GetAccountInformation();
	System::UnicodeString __fastcall GetAccountTradeList(const System::UnicodeString aSymbol, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aFromId = 0x0, int aLimit = 0x1f4);
public:
...
public:
	...
	System::UnicodeString __fastcall GetFundingRateHistory(const System::UnicodeString aSymbol, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x64);
	System::UnicodeString __fastcall GetOpenInterest(const System::UnicodeString aSymbol = System::UnicodeString());
	System::UnicodeString __fastcall GetOpenInterestStatistics(const System::UnicodeString aSymbol, const TsgcHTTPBinanceFutOpenInterestPeriods aPeriod, int aLimit = 0x1e, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL));
	System::UnicodeString __fastcall GetTopTraderAccountRatio(const System::UnicodeString aSymbol, const TsgcHTTPBinanceFutOpenInterestPeriods aPeriod, int aLimit = 0x1e, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL));
	System::UnicodeString __fastcall GetTopTraderPositionRatio(const System::UnicodeString aSymbol, const TsgcHTTPBinanceFutOpenInterestPeriods aPeriod, int aLimit = 0x1e, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL));
	System::UnicodeString __fastcall GetGlobalAccountRatio(const System::UnicodeString aSymbol, const TsgcHTTPBinanceFutOpenInterestPeriods aPeriod, int aLimit = 0x1e, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL));
	System::UnicodeString __fastcall GetTakerVolume(const System::UnicodeString aSymbol, const TsgcHTTPBinanceFutOpenInterestPeriods aPeriod, int aLimit = 0x1e, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL));
	...
	System::UnicodeString __fastcall QueryCurrentOpenOrder(const System::UnicodeString aSymbol, __int64 aOrderId = (__int64)(0LL), const System::UnicodeString aOrigClientOrderId = System::UnicodeString());
	System::UnicodeString __fastcall GetOpenOrders(const System::UnicodeString aSymbol = System::UnicodeString());
	System::UnicodeString __fastcall GetAllOrders(const System::UnicodeString aSymbol, __int64 aOrderId = (__int64)(0LL), __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x64);
	...
	System::UnicodeString __fastcall GetPositionMarginChangeHistory(const System::UnicodeString aSymbol, int aType = 0x0, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x1f4);
	System::UnicodeString __fastcall GetPositionInformation(const System::UnicodeString aSymbol = System::UnicodeString());
	System::UnicodeString __fastcall GetAccountTradeList(const System::UnicodeString aSymbol, __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aFromId = 0x0, int aLimit = 0x1f4);
	System::UnicodeString __fastcall GetIncomeHistory(const System::UnicodeString aSymbol = System::UnicodeString(), const System::UnicodeString aIncomeType = System::UnicodeString(), __int64 aStartTime = (__int64)(0LL), __int64 aEndTime = (__int64)(0LL), int aLimit = 0x64);
