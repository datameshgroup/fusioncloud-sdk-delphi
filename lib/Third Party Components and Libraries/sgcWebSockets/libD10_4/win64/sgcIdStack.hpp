...
// (DO NOT EDIT: machine generated header) 'sgcIdStack.pas' rev: 34.00 (Windows)
...
public:
	...
	virtual NativeUInt __fastcall Accept(NativeUInt ASocket, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion) = 0 /* overload */;
	virtual void __fastcall Bind(NativeUInt ASocket, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	virtual void __fastcall Connect(const NativeUInt ASocket, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	...
	virtual void __fastcall GetPeerName(NativeUInt ASocket, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion) = 0 /* overload */;
	void __fastcall GetSocketName(NativeUInt ASocket, System::UnicodeString &VIP, System::Word &VPort)/* overload */;
	virtual void __fastcall GetSocketName(NativeUInt ASocket, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion) = 0 /* overload */;
	...
	virtual NativeUInt __fastcall NewSocketHandle(const int ASocketType, const int AProtocol, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0), const bool ANonBlocking = false) = 0 ;
	...
	virtual int __fastcall Receive(NativeUInt ASocket, Sgcidglobal::TIdBytes &VBuffer) = 0 ;
	virtual int __fastcall Send(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset = 0x0, const int ASize = 0xffffffff) = 0 ;
	virtual int __fastcall ReceiveFrom(NativeUInt ASocket, Sgcidglobal::TIdBytes &VBuffer, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion) = 0 ;
	int __fastcall SendTo(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0))/* overload */;
	virtual int __fastcall SendTo(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset, const int ASize, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 /* overload */;
	virtual unsigned __fastcall ReceiveMsg(NativeUInt ASocket, Sgcidglobal::TIdBytes &VBuffer, TIdPacketInfo* APkt) = 0 ;
	...
	virtual void __fastcall SetMulticastTTL(NativeUInt AHandle, const System::Byte AValue, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	virtual void __fastcall SetLoopBack(NativeUInt AHandle, const bool AValue, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	virtual void __fastcall DropMulticastMembership(NativeUInt AHandle, const System::UnicodeString AGroupIP, const System::UnicodeString ALocalIP, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	virtual void __fastcall AddMulticastMembership(NativeUInt AHandle, const System::UnicodeString AGroupIP, const System::UnicodeString ALocalIP, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	virtual System::Word __fastcall CalcCheckSum(const Sgcidglobal::TIdBytes AData);
	virtual void __fastcall WriteChecksum(NativeUInt s, Sgcidglobal::TIdBytes &VBuffer, const int AOffset, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
