...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Client_WinHTTP.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TOnReadMessageEvent)(System::TObject* Sender, System::TArray__1<System::Byte> Buffer, Sgcwebsocket_winapi::WINHTTP_WEB_SOCKET_BUFFER_TYPE BufferType, unsigned BufferSize);
...
private:
	...
	bool FDisconnecting;
	System::TArray__1<System::Byte> FAsyncBuffer;
	int FConnectTimeout;
	int FReadTimeout;
	bool FActive;
	bool FAsynchronous;
	...
	System::TArray__1<System::Byte> FFragmentedUTF8Bytes;
	System::TArray__1<System::Byte> FFragmentedBinaryBytes;
...
private:
	...
	void __fastcall DoReadMessageEvent(System::TArray__1<System::Byte> Buffer, Sgcwebsocket_winapi::WINHTTP_WEB_SOCKET_BUFFER_TYPE BufferType, unsigned BufferSize);
	void __fastcall DoDisconnectEvent();
	
protected:
	virtual void __fastcall OnReadMessageEvent(System::TObject* Sender, System::TArray__1<System::Byte> Buffer, Sgcwebsocket_winapi::WINHTTP_WEB_SOCKET_BUFFER_TYPE BufferType, unsigned BufferSize);
...
private:
	void __fastcall DoWriteFragmentedUTF8(const System::TArray__1<System::Byte> aBuffer);
	void __fastcall DoWriteFragmentedBinary(const System::TArray__1<System::Byte> aBuffer);
