...
public:
	...
	__property NativeUInt iocompletition = {read=FIOCompletition, write=FIOCompletition};
...
public:
	...
	__property System::TArray__1<System::Byte> buffer = {read=FBuffer, write=FBuffer};
