...
typedef HRESULT __stdcall (*TsgcHttpAddUrlToUrlGroup)(unsigned __int64 UrlGroupId, System::WideChar * pFullyQualifiedUrl, unsigned __int64 UrlContext/* = (unsigned __int64)(0ULL)*/, unsigned Reserved/* = (unsigned)(0x0)*/);
...
#define CS_FLAG_SHUDOWN (Winapi::Windows::POverlapped)(0xffffffffffffffffULL)
...
extern DELPHI_PACKAGE HRESULT __stdcall HttpAddUrlToUrlGroup(unsigned __int64 UrlGroupId, System::WideChar * pFullyQualifiedUrl, unsigned __int64 UrlContext = (unsigned __int64)(0ULL), unsigned Reserved = (unsigned)(0x0));
