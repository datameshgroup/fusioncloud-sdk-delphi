...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_JWT_Helpers.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE System::UnicodeString __fastcall sgcEncodeBase64(const System::TArray__1<System::Byte> aBytes);
...
extern DELPHI_PACKAGE System::TArray__1<System::Byte> __fastcall sgcDecodeBase64(const System::UnicodeString aValue);
}	/* namespace Sgchttp_jwt_helpers */
