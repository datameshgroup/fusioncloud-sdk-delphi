...
// (DO NOT EDIT: machine generated header) 'sgcP2P_TURN_Classes.pas' rev: 34.00 (Windows)
...
public:
	__property System::DynamicArray<System::Byte> Data = {read=FData, write=FData};
...
public:
	virtual void __fastcall Read(const System::DynamicArray<System::Byte> Value);
	bool __fastcall AllDataReceived(const System::DynamicArray<System::Byte> Value);
