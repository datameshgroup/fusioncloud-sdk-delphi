...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Server.pas' rev: 34.00 (Android)
...
protected:
	...
	virtual bool __fastcall DoHTTP2Request(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, Sgcidcustomhttpserver::TIdHTTPRequestInfo* const aRequest, System::Classes::TStringList* const aHeaders, const System::TArray__1<System::Byte> aBytes);
