...
// (DO NOT EDIT: machine generated header) 'sgcIdSync.pas' rev: 34.00 (Android)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDSYNC)
using namespace Sgcidsync;
#endif
#pragma pack(pop)
#pragma option pop
