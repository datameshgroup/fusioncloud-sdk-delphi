...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_API_Bitfinex.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 CS_DEC_S = System::Int8(0x8);
static constexpr System::Int8 CS_TIME_S = System::Int8(0x20);
static constexpr int CS_SEQ_ALL = int(0x10000);
static constexpr int CHECKSUM = int(0x20000);
}	/* namespace Sgcwebsocket_api_bitfinex */
