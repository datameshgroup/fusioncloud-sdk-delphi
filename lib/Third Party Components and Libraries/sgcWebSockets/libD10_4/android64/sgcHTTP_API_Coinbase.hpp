...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_API_Coinbase.pas' rev: 34.00 (Android)
...
public:
	...
	System::UnicodeString __fastcall CreateReportFills(System::TDateTime aStartDate, System::TDateTime aEndDate, const System::UnicodeString aProductId, const System::UnicodeString aFormat = u"pdf", const System::UnicodeString aEmail = System::UnicodeString());
	System::UnicodeString __fastcall CreateReportAccount(System::TDateTime aStartDate, System::TDateTime aEndDate, const System::UnicodeString aAccountId, const System::UnicodeString aFormat = u"pdf", const System::UnicodeString aEmail = System::UnicodeString());
