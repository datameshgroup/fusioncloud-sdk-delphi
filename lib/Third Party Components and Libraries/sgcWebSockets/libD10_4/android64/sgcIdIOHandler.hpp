...
// (DO NOT EDIT: machine generated header) 'sgcIdIOHandler.pas' rev: 34.00 (Android)
...
public:
	...
	void __fastcall Capture(System::Classes::TStream* ADest, /* out */ int &VLineCount, const System::UnicodeString ADelim = u".", bool AUsesDotTransparency = true, Sgcidglobal::_di_IIdTextEncoding AByteEncoding = Sgcidglobal::_di_IIdTextEncoding())/* overload */;
	...
	void __fastcall Capture(System::Classes::TStrings* ADest, /* out */ int &VLineCount, const System::UnicodeString ADelim = u".", bool AUsesDotTransparency = true, Sgcidglobal::_di_IIdTextEncoding AByteEncoding = Sgcidglobal::_di_IIdTextEncoding())/* overload */;
	...
	System::UnicodeString __fastcall ReadLnRFC(bool &VMsgEnd, const System::UnicodeString ALineTerminator, const System::UnicodeString ADelim = u".", Sgcidglobal::_di_IIdTextEncoding AByteEncoding = Sgcidglobal::_di_IIdTextEncoding())/* overload */;
