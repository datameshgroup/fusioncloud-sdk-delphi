...
// (DO NOT EDIT: machine generated header) 'sgcUDP_Server.pas' rev: 34.00 (Android)
...
class PASCALIMPLEMENTATION TsgcIdUDPServer : public Sgcidudpserver::TIdUDPServer
{
	typedef Sgcidudpserver::TIdUDPServer inherited;
	
protected:
	virtual Sgcidsockethandle::TIdSocketHandle* __fastcall GetSocketBinding(const System::UnicodeString aIPAddress, int aPort);
	
public:
	Sgcidsockethandle::TIdSocketHandle* __fastcall AddBinding(const System::UnicodeString aIPAddress, int aPort, const System::UnicodeString aName = System::UnicodeString());
...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TsgcIdUDPServer(System::Classes::TComponent* AOwner)/* overload */ : Sgcidudpserver::TIdUDPServer(AOwner) { }
	
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TsgcIdUDPServer()/* overload */ : Sgcidudpserver::TIdUDPServer() { }
...
protected:
	...
	virtual void __fastcall DoWriteData(const System::TArray__1<System::Byte> aBytes)/* overload */;
public:
...
protected:
	...
	inline void __fastcall  DoWriteData(const System::UnicodeString aIPAddress, System::Word aPort, const System::TArray__1<System::Byte> aValue){ Sgcudp_classes::TsgcUDPSocket_Base::DoWriteData(aIPAddress, aPort, aValue); }
...
public:
	Sgcidsockethandle::TIdSocketHandle* __fastcall AddBinding(const System::UnicodeString aIPAddress, int aPort, const System::UnicodeString aName = System::UnicodeString());
	bool __fastcall RemoveBinding(const System::UnicodeString aIPAddress, int aPort);
	Sgcidsockethandle::TIdSocketHandle* __fastcall GetBinding(const System::UnicodeString aIPAddress, int aPort);
...
protected:
	...
	virtual TsgcUDPSocketServer* __fastcall DoCreateUDPSocket(Sgcidsockethandle::TIdSocketHandle* const ABinding);
	virtual void __fastcall OnClientReadEvent(Sgcidudpserver::TIdUDPListenerThread* AThread, const Sgcidglobal::TIdBytes AData, Sgcidsockethandle::TIdSocketHandle* ABinding);
	virtual void __fastcall OnClientExceptionEvent(Sgcidudpserver::TIdUDPListenerThread* AThread, Sgcidsockethandle::TIdSocketHandle* ABinding, const System::UnicodeString AMessage, const System::TClass AExceptionClass);
...
protected:
	...
	virtual bool __fastcall DoWatchDogMonitorRead(const System::TArray__1<System::Byte> Bytes);
...
protected:
	virtual void __fastcall DoWriteData(const System::UnicodeString aIP, System::Word aPort, const System::TArray__1<System::Byte> aBytes, const System::UnicodeString aSourceIP = System::UnicodeString(), System::Word aSourcePort = (System::Word)(0x0));
	
public:
	void __fastcall WriteData(const System::UnicodeString aIP, System::Word aPort, const System::UnicodeString aValue)/* overload */;
	void __fastcall WriteData(const System::UnicodeString aIP, System::Word aPort, const System::TArray__1<System::Byte> aBytes)/* overload */;
	...
	void __fastcall WriteData(const System::UnicodeString aSourceIP, const System::Word aSourcePort, const System::UnicodeString aIP, System::Word aPort, const System::TArray__1<System::Byte> aBytes)/* overload */;
...
_DECLARE_METACLASS(System::TMetaClass, TsgcUDPSocketServerClass);
