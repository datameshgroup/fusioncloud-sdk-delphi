...
// (DO NOT EDIT: machine generated header) 'sgcIdCTypes.pas' rev: 34.00 (Android)

#ifndef SgcidctypesHPP
#define SgcidctypesHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDCTYPES)
using namespace Sgcidctypes;
#endif
#pragma pack(pop)
#pragma option pop
