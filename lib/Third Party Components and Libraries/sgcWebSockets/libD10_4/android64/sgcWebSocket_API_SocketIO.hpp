...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_API_SocketIO.pas' rev: 34.00 (Android)
...
typedef void __fastcall (__closure *TsgcWSOnHTTPConnectionSSL)(System::TObject* Sender, Sgcidssl::TIdSSLIOHandlerSocketBase* aSSLHandler);
