...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_Amazon_AWS_Signature.pas' rev: 34.00 (Android)
...
private:
	...
	System::TArray__1<System::Byte> __fastcall GetHMACSHA256_Indy(const System::UnicodeString aValue, Sgcidglobal::TIdBytes aSecret);
