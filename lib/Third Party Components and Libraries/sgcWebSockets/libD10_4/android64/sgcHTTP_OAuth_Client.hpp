...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_OAuth_Client.pas' rev: 34.00 (Android)
...
protected:
	...
	virtual void __fastcall OnCommandGetEvent(Sgcidcontext::TIdContext* AContext, Sgcidcustomhttpserver::TIdHTTPRequestInfo* ARequestInfo, Sgcidcustomhttpserver::TIdHTTPResponseInfo* AResponseInfo) = 0 ;
