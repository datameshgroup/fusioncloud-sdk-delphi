...
// (DO NOT EDIT: machine generated header) 'sgcHTTP_Google_Cloud.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define CS_GOOGLE_CLOUD_HTTP_GET u"GET"
#define CS_GOOGLE_CLOUD_HTTP_POST u"POST"
#define CS_GOOGLE_CLOUD_HTTP_PUT u"PUT"
#define CS_GOOGLE_CLOUD_HTTP_DELETE u"DELETE"
#define CS_GOOGLE_CLOUD_HTTP_PATCH u"PATCH"
}	/* namespace Sgchttp_google_cloud */
