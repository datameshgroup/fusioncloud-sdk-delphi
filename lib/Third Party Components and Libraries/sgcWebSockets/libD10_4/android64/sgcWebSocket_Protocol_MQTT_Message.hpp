...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Protocol_MQTT_Message.pas' rev: 34.00 (Android)
...
public:
	...
	void __fastcall AddBytes(Sgcidglobal::TIdBytes aBytes);
	...
	__property Sgcidglobal::TIdBytes Bytes = {read=FBytes};
	__property int Size = {read=GetSize, nodefault};
public:
...
protected:
	int __fastcall GetInteger(const Sgcidglobal::TIdBytes aBytes, int aLength, int &aOffset);
	bool __fastcall GetBoolean(const Sgcidglobal::TIdBytes aBytes, int &aOffset);
	System::UnicodeString __fastcall GetString(const Sgcidglobal::TIdBytes aBytes, int &aOffset);
	virtual void __fastcall DoReadBytes(const Sgcidglobal::TIdBytes aBytes) = 0 ;
	
public:
	void __fastcall ReadBytes(const Sgcidglobal::TIdBytes aBytes);
public:
...
protected:
	virtual void __fastcall DoReadBytes(const Sgcidglobal::TIdBytes aBytes);
...
class PASCALIMPLEMENTATION TsgcWSMQTTMessage : public System::Classes::TComponent
{
	typedef System::Classes::TComponent inherited;
	
private:
	System::UnicodeString FConnectionId;
	System::Classes::TStream* FStreamWrite;
	System::Classes::TStream* FStreamRead;
	unsigned FThreadId;
	TsgcWSMQTTReadPacketBuffer* FStreamReadPacketBuffer;
	System::Classes::TStream* __fastcall GetStreamWrite();
...
public:
	...
	void __fastcall ClearStreamWrite();
	void __fastcall ClearStreamReadTCP();
	__property System::Classes::TStream* StreamWrite = {read=GetStreamWrite, write=FStreamWrite};
...
private:
	...
	Sgcidglobal::TIdBytes __fastcall GetRemainingLength();
	...
	Sgcidglobal::TIdBytes __fastcall GetMSBLSB(int aValue);
...
protected:
	System::Classes::TStream* __fastcall WriteStream();
...
public:
	...
	virtual System::Classes::TStream* __fastcall DoConnect(bool aAuthentication, System::UnicodeString aAuthUser, System::UnicodeString aAuthPass, bool aWillFlag, System::UnicodeString aWillTopic, System::UnicodeString aWillText, Sgcwebsocket_types::TmqttQoS aWillQoS, bool aWillRetain, bool aKeepAliveEnabled, int aKeepAliveInterval);
	virtual System::Classes::TStream* __fastcall DoPing();
	virtual System::Classes::TStream* __fastcall DoPublish(System::Word aPacketIdentifier, const System::UnicodeString aTopic, const System::UnicodeString aText, Sgcwebsocket_types::TmqttQoS aQoS, bool aRetain, bool aDuplicate)/* overload */;
	virtual System::Classes::TStream* __fastcall DoPublish(System::Word aPacketIdentifier, const System::UnicodeString aTopic, System::Classes::TStream* aStream, Sgcwebsocket_types::TmqttQoS aQoS, bool aRetain, bool aDuplicate)/* overload */;
	virtual System::Classes::TStream* __fastcall DoSubscribe(System::Word aPacketIdentifier, TsgcWSTopics* aTopics);
	virtual System::Classes::TStream* __fastcall DoUnSubscribe(System::Word aPacketIdentifier, TsgcWSTopics* aTopics);
	virtual System::Classes::TStream* __fastcall DoPubAck(System::Word aPacketIdentifier);
	virtual System::Classes::TStream* __fastcall DoPubRec(System::Word aPacketIdentifier);
	virtual System::Classes::TStream* __fastcall DoPubRel(System::Word aPacketIdentifier);
	virtual System::Classes::TStream* __fastcall DoPubComp(System::Word aPacketIdentifier);
	virtual System::Classes::TStream* __fastcall DoDisconnect(int aReasonCode = 0x0);
	virtual System::Classes::TStream* __fastcall DoAuth(bool aReAuthenticate);
...
private:
	void __fastcall DoReadCONNACK(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadPUBLISH(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadPUBACK(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadPUBREC(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadPUBREL(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadPUBCOMP(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadSUBACK(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadUNSUBACK(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadDISCONNECT(const Sgcidglobal::TIdBytes aBytes);
	void __fastcall DoReadAUTH(const Sgcidglobal::TIdBytes aBytes);
	bool FCleanSession;
