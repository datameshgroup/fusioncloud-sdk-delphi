...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Protocol_STOMP_RabbitMQ_Client.pas' rev: 34.00 (Android)
...
public:
	...
	void __fastcall PublishEx(const System::UnicodeString aDestination, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
	...
	void __fastcall PublishTopic(const System::UnicodeString aTopic, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
	...
	void __fastcall PublishQueue(const System::UnicodeString aQueue, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
	...
	void __fastcall PublishQueueOutside(const System::UnicodeString aQueue, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
	...
	void __fastcall PublishTemporaryQueue(const System::UnicodeString aQueue, const System::UnicodeString aReplyTo, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
	...
	void __fastcall PublishExchange(const System::UnicodeString aName, const System::UnicodeString aRoutingKey, const System::UnicodeString aText, const System::UnicodeString aContentType = u"text/plain", const System::UnicodeString aTransaction = System::UnicodeString());
