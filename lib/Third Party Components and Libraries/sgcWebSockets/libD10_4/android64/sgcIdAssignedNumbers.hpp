...
// (DO NOT EDIT: machine generated header) 'sgcIdAssignedNumbers.pas' rev: 34.00 (Android)

#ifndef SgcidassignednumbersHPP
#define SgcidassignednumbersHPP
...
namespace Sgcidassignednumbers
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SGCIDASSIGNEDNUMBERS)
using namespace Sgcidassignednumbers;
#endif
#pragma pack(pop)
#pragma option pop
