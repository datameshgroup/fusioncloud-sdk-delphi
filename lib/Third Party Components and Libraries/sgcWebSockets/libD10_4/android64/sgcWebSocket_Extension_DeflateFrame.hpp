...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Extension_DeflateFrame.pas' rev: 34.00 (Android)
...
private:
	Sgcidglobal::TIdBytes FReadBytes;
	System::Classes::TStringStream* FDefStream;
	void __fastcall DoInitializeDeflateBuffer();
...
protected:
	...
	long __fastcall IdRead(z_stream &aStrmRec, Sgcidglobal::TIdBytes &VBuffer, int AOffset);
	long __fastcall DoRead(z_stream &aStrmRec, void *aBuffer);
...
public:
	...
	__fastcall virtual ~TsgcWSExtension_DeflateFrame();
	bool __fastcall InflateFrame(System::Classes::TStream* &aStream);
	bool __fastcall DeflateFrame(System::Classes::TStream* &aStream);
