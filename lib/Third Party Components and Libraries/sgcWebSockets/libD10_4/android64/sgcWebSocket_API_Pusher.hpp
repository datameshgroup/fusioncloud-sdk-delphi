...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_API_Pusher.pas' rev: 34.00 (Android)
...
public:
	void __fastcall Ping(const System::UnicodeString aData = u"{}");
	...
	void __fastcall Publish(const System::UnicodeString aEvent, const System::UnicodeString aChannel, TsgcWSPusherChannels aChannelType = (TsgcWSPusherChannels)(0x0), const System::UnicodeString aData = u"{}");
