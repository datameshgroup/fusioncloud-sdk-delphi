...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Protocol_WAMP2_Client.pas' rev: 34.00 (Android)
...
public:
	void __fastcall Subscribe(const System::UnicodeString aTopic, const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall UnSubscribe(const __int64 aSubscriptionId, const __int64 aRequestId = (__int64)(0LL));
	...
	void __fastcall Publish(const System::UnicodeString aTopic, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall Call(const System::UnicodeString aProcedure, const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall RegisterCall(const System::UnicodeString aProcedure, const System::UnicodeString aOptions = u"{}", const __int64 aRequestId = (__int64)(0LL));
	void __fastcall UnRegisterCall(const __int64 aRegistrationId, const __int64 aRequestId = (__int64)(0LL));
	void __fastcall Invocation(const __int64 aRegistrationId, const System::UnicodeString aDetails = System::UnicodeString(), const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const __int64 aRequestId = (__int64)(0LL));
	void __fastcall InvocationError(const __int64 aRequestId, const System::UnicodeString aDetails = u"{}", const System::UnicodeString aTopic = System::UnicodeString(), const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString());
	void __fastcall Yield(const System::UnicodeString aOptions = u"{}", const System::UnicodeString aArguments = System::UnicodeString(), const System::UnicodeString aArgumentsKw = System::UnicodeString(), const __int64 aRequestId = (__int64)(0LL));
