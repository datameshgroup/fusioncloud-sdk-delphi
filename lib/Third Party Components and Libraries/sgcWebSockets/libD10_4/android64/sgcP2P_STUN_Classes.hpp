...
// (DO NOT EDIT: machine generated header) 'sgcP2P_STUN_Classes.pas' rev: 34.00 (Android)
...
typedef void __fastcall (__closure *TsgcSTUNRequestMessageIntegrityKeyEvent)(System::TObject* Sender, const System::UnicodeString aTransactionId, System::TArray__1<System::Byte> &MessageIntegrityKey);
...
public:
	...
	void __fastcall Read(const System::TArray__1<System::Byte> aBytes);
	System::TArray__1<System::Byte> __fastcall Write();
	...
	__property System::TArray__1<System::Byte> TransactionId = {read=FTransactionId, write=FTransactionId};
...
_DECLARE_METACLASS(System::TMetaClass, TsgcSTUN_Attribute_Class);
...
protected:
	virtual System::TArray__1<System::Byte> __fastcall GetPayload() = 0 ;
	virtual void __fastcall DoReadPayload(System::TArray__1<System::Byte> Value) = 0 ;
	virtual System::Word __fastcall GetPayloadLength();
	
public:
	__fastcall virtual TsgcSTUN_Attribute();
	virtual void __fastcall Read(System::TArray__1<System::Byte> Value, int &aOffset);
...
protected:
	virtual void __fastcall DoReadPayload(System::TArray__1<System::Byte> Value);
public:
...
protected:
	virtual void __fastcall DoReadPayload(System::TArray__1<System::Byte> Value);
	virtual System::TArray__1<System::Byte> __fastcall GetPayload();
...
private:
	System::TArray__1<System::Byte> FTransactionId;
	void __fastcall SetTransactionId(const System::TArray__1<System::Byte> Value);
...
public:
	...
	__property System::TArray__1<System::Byte> TransactionId = {read=FTransactionId, write=SetTransactionId};
public:
...
private:
	System::TArray__1<System::Byte> FKey;
	System::TArray__1<System::Byte> FPayLoad;
	void __fastcall SetKey(const System::TArray__1<System::Byte> Value);
	void __fastcall SetPayLoad(const System::TArray__1<System::Byte> Value);
...
public:
	__property System::TArray__1<System::Byte> Key = {read=FKey, write=SetKey};
	__property System::TArray__1<System::Byte> PayLoad = {read=FPayLoad, write=SetPayLoad};
public:
...
private:
	System::TArray__1<System::Byte> FToken;
...
public:
	...
	__property System::TArray__1<System::Byte> Token = {read=FToken, write=FToken};
public:
...
private:
	System::TArray__1<System::Byte> FTieBreaker;
	void __fastcall SetTieBreaker(const System::TArray__1<System::Byte> Value);
...
public:
	...
	__property System::TArray__1<System::Byte> TieBreaker = {read=FTieBreaker, write=SetTieBreaker};
public:
...
private:
	bool __fastcall IsFingerprintValid(TsgcSTUN_Attribute* const aAttribute, const System::TArray__1<System::Byte> aBytes);
	void __fastcall DoValidateMessageIntegrity(TsgcSTUN_Attribute* const aAttribute, const System::TArray__1<System::Byte> aBytes, bool aICE);
...
protected:
	void __fastcall DoReadHeader(System::TArray__1<System::Byte> Bytes);
	void __fastcall DoReadPayload(System::TArray__1<System::Byte> Bytes);
	virtual System::TArray__1<System::Byte> __fastcall DoWrite();
	
public:
	void __fastcall Read(System::TArray__1<System::Byte> Bytes);
	System::TArray__1<System::Byte> __fastcall Write();
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word CS_STUN_DEFAULT_PORT = System::Word(0xd96);
static constexpr int CS_STUN_MAGIC_COOKIE = int(0x2112a442);
static constexpr int CS_STUN_FINGERPRINT_XOR = int(0x5354554e);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_MAPPED_ADDRESS = System::Int8(0x1);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_USERNAME = System::Int8(0x6);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_MESSAGE_INTEGRITY = System::Int8(0x8);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_ERROR_CODE = System::Int8(0x9);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_UNKNOWN_ATTRIBUTES = System::Int8(0xa);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_REALM = System::Int8(0x14);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_NONCE = System::Int8(0x15);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_XOR_MAPPED_ADDRESS = System::Int8(0x20);
static constexpr System::Word CS_STUN_ATTRIBUTE_OPTIONAL_SOFTWARE = System::Word(0x8022);
static constexpr System::Word CS_STUN_ATTRIBUTE_OPTIONAL_ALTERNATE_SERVER = System::Word(0x8023);
static constexpr System::Word CS_STUN_ATTRIBUTE_OPTIONAL_FINGERPRINT = System::Word(0x8028);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_CHANGE_REQUEST = System::Int8(0x3);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_RESPONSE_PORT = System::Int8(0x27);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_PADDING = System::Int8(0x26);
static constexpr System::Word CS_STUN_ATTRIBUTE_CACHE_TIMEOUT = System::Word(0x8027);
static constexpr System::Word CS_STUN_ATTRIBUTE_RESPONSE_ORIGIN = System::Word(0x802b);
static constexpr System::Word CS_STUN_ATTRIBUTE_OTHER_ADDRESS = System::Word(0x802c);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_SOURCE_ADDRESS = System::Int8(0x4);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_CHANGED_ADDRESS = System::Int8(0x5);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_MESSAGE_INTEGRITY_SHA256 = System::Int8(0x1c);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_PASSWORD_ALGORITHM = System::Int8(0x1d);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUIRED_USERHASH = System::Int8(0x1e);
static constexpr System::Word CS_STUN_ATTRIBUTE_OPTIONAL_PASSWORD_ALGORITHMS = System::Word(0x8002);
static constexpr System::Word CS_STUN_ATTRIBUTE_OPTIONAL_ALTERNATE_DOMAIN = System::Word(0x8003);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_CHANNEL_NUMBER = System::Int8(0xc);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_LIFETIME = System::Int8(0xd);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_XOR_PEER_ADDRESS = System::Int8(0x12);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_DATA = System::Int8(0x13);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_XOR_RELAYED_ADDRESS = System::Int8(0x16);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUESTED_ADDRESS_FAMILY = System::Int8(0x17);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_EVENT_PORT = System::Int8(0x18);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_REQUESTED_TRANSPORT = System::Int8(0x19);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_DONT_FRAGMENT = System::Int8(0x1a);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_RESERVATION_TOKEN = System::Int8(0x22);
static constexpr System::Word CS_STUN_ATTRIBUTE_ADDITIONAL_ADDRESS_FAMILY = System::Word(0x8000);
static constexpr System::Word CS_STUN_ATTRIBUTE_ADDRESS_ERROR_CODE = System::Word(0x8001);
static constexpr System::Word CS_STUN_ATTRIBUTE_ICMP = System::Word(0x8004);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_PRIORITY = System::Int8(0x24);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_USE_CANDIDATE = System::Int8(0x25);
static constexpr System::Word CS_STUN_ATTRIBUTE_ICE_CONTROLLED = System::Word(0x8029);
static constexpr System::Word CS_STUN_ATTRIBUTE_ICE_CONTROLLING = System::Word(0x802a);
static constexpr System::Int8 CS_STUN_HEADER_LENGTH = System::Int8(0x14);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_HEADER_LENGTH = System::Int8(0x4);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_FINGERPRINT_LENGTH = System::Int8(0x4);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_MESSAGE_INTEGRITY_LENGTH = System::Int8(0x14);
static constexpr System::Int8 CS_STUN_ATTRIBUTE_MESSAGE_INTEGRITY_SHA256_LENGTH = System::Int8(0x20);
#define CS_STUN_RELAY u"Relay"
