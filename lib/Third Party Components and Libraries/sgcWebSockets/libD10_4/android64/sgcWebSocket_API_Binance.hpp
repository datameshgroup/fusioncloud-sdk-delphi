...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_API_Binance.pas' rev: 34.00 (Android)
...
public:
	int __fastcall SubscribeAggregateTrades(const System::UnicodeString aSymbol);
	int __fastcall UnSubscribeAggregateTrades(const System::UnicodeString aSymbol);
	int __fastcall SubscribeMarkPrice(const System::UnicodeString aSymbol, const System::UnicodeString aUpdateSpeed = u"@1s");
	int __fastcall UnSubscribeMarkPrice(const System::UnicodeString aSymbol);
	int __fastcall SubscribeMarkPriceAllMarket(const System::UnicodeString aSymbol, const System::UnicodeString aUpdateSpeed = u"@1s");
