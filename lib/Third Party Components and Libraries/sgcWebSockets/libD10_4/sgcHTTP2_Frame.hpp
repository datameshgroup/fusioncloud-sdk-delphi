...
// (DO NOT EDIT: machine generated header) 'sgcHTTP2_Frame.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef System::DynamicArray<System::Byte> _dt_Sgchttp2_frame_1;
typedef void __fastcall (__closure *TsgcHTTP2WriteBytesEvent)(System::TObject* Sender, const _dt_Sgchttp2_frame_1 aBytes);
...
typedef System::DynamicArray<System::Byte> _dt_Sgchttp2_frame_2;
typedef void __fastcall (__closure *TsgcHTTP2ReadResponseFragmentEvent)(System::TObject* Sender, TsgcHTTP2_StreamResponse* const Stream, const _dt_Sgchttp2_frame_2 aBytes);
...
public:
	...
	__property System::DynamicArray<System::Byte> PayLoad = {read=FPayLoad, write=FPayLoad};
...
protected:
	virtual int __fastcall WriteFrameBytes(Sgchttp2_types::Th2FrameType aFrameType, System::Byte aFrameFlags, System::Byte aFrameFlagsPartial, int aStreamIdentifier, System::DynamicArray<System::Byte> aPayLoad, int aWindowSize = 0x0);
...
protected:
	...
	virtual void __fastcall DoReadPayload(const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoValidate(const System::DynamicArray<System::Byte> aBytes) = 0 ;
	
public:
	void __fastcall ReadFlags(const System::Byte aByte);
	void __fastcall ReadPayload(const System::DynamicArray<System::Byte> aBytes);
...
protected:
	...
	virtual void __fastcall DoReadPayload(const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall DoValidate(const System::DynamicArray<System::Byte> aBytes);
...
public:
	...
	__property System::DynamicArray<System::Byte> Data = {read=FData};
...
protected:
	...
	System::DynamicArray<System::Byte> __fastcall GetHeadersPayLoad(System::Classes::TStringList* const Headers);
...
protected:
	System::DynamicArray<System::Byte> __fastcall GetPayload();
...
private:
	void __fastcall DoWriteSetting(int aIdentifier, int aValue, System::DynamicArray<System::Byte> &aPayLoad);
...
private:
	...
	void __fastcall DoWritePostDataStream(TsgcHTTP2_StreamResponse* const aStreamResponse, const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoDonePostDataStream(TsgcHTTP2_StreamResponse* const aStreamResponse);
	void __fastcall DoReadPayLoadByStreamFrame(TsgcHTTP2_Read_Stream_Frame* const aStreamFrame, const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoReadLength(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoReadFrameType(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoReadFlags(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoReadStreamIdentifier(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoReadPayload(const System::DynamicArray<System::Byte> aBytes);
	void __fastcall DoValidateFrame();
	void __fastcall DoValidateHeaderContentLength(TsgcHTTP2_StreamResponse* const aStream);
	
protected:
	bool __fastcall DoReadBuffer(System::DynamicArray<System::Byte> &aBuffer, int aCount);
	virtual void __fastcall DoReadBytes();
	
public:
	void __fastcall ReadBytes(const System::DynamicArray<System::Byte> aBytes);
...
protected:
	...
	virtual void __fastcall DoReadResponseFragmentEvent(TsgcHTTP2_StreamResponse* const aStream, const System::DynamicArray<System::Byte> aBytes);
	virtual void __fastcall OnWriteBytesEvent(System::TObject* Sender, const System::DynamicArray<System::Byte> aBytes);
