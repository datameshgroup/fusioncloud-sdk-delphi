...
// (DO NOT EDIT: machine generated header) 'sgcP2P_STUN_Server.pas' rev: 34.00 (Windows)
...
public:
	Sgcidsockethandle::TIdSocketHandle* __fastcall AddBinding(const System::UnicodeString aIPAddress, int aPort);
...
protected:
	...
	virtual void __fastcall DoReadData(Sgcudp_classes::TsgcUDPSocket* const Socket, const System::DynamicArray<System::Byte> Bytes);
