...
// (DO NOT EDIT: machine generated header) 'sgcIdStackBSDBase.pas' rev: 34.00 (Windows)
...
protected:
	...
	void __fastcall MembershipSockOpt(NativeUInt AHandle, const System::UnicodeString AGroupIP, const System::UnicodeString ALocalIP, const int ASockOpt, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0));
...
public:
	...
	virtual int __fastcall Receive(NativeUInt ASocket, Sgcidglobal::TIdBytes &VBuffer);
	virtual int __fastcall Send(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset = 0x0, const int ASize = 0xffffffff);
	virtual int __fastcall ReceiveFrom(NativeUInt ASocket, Sgcidglobal::TIdBytes &VBuffer, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion);
	virtual int __fastcall SendTo(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset, const int ASize, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0))/* overload */;
	...
	virtual int __fastcall RecvFrom(const NativeUInt ASocket, void *ABuffer, const int ALength, const int AFlags, System::UnicodeString &VIP, System::Word &VPort, Sgcidglobal::TIdIPVersion &VIPVersion) = 0 ;
	virtual void __fastcall WSSendTo(NativeUInt ASocket, const void *ABuffer, const int ABufferLength, const int AFlags, const System::UnicodeString AIP, const System::Word APort, Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)) = 0 ;
	...
	virtual NativeUInt __fastcall NewSocketHandle(const int ASocketType, const int AProtocol, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0), const bool ANonBlocking = false);
	virtual void __fastcall SetMulticastTTL(NativeUInt AHandle, const System::Byte AValue, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0));
	virtual void __fastcall SetLoopBack(NativeUInt AHandle, const bool AValue, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0));
	virtual void __fastcall DropMulticastMembership(NativeUInt AHandle, const System::UnicodeString AGroupIP, const System::UnicodeString ALocalIP, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0));
	virtual void __fastcall AddMulticastMembership(NativeUInt AHandle, const System::UnicodeString AGroupIP, const System::UnicodeString ALocalIP, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0));
public:
...
public:
	inline int __fastcall  SendTo(NativeUInt ASocket, const Sgcidglobal::TIdBytes ABuffer, const int AOffset, const System::UnicodeString AIP, const System::Word APort, const Sgcidglobal::TIdIPVersion AIPVersion = (Sgcidglobal::TIdIPVersion)(0x0)){ return Sgcidstack::TIdStack::SendTo(ASocket, ABuffer, AOffset, AIP, APort, AIPVersion); }
