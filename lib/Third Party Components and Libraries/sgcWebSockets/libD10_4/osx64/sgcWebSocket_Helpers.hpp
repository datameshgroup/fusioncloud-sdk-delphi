...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Helpers.pas' rev: 34.00 (MacOS)
...
//-- type declarations -------------------------------------------------------
typedef System::DynamicArray<System::Byte> TsgcArrayOfBytes;
...
extern DELPHI_PACKAGE Sgcidglobal::TIdBytes __fastcall sgcStringToBytes(const System::UnicodeString aText);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall sgcArrayOfBytesToString(System::DynamicArray<System::Byte> aArray);
extern DELPHI_PACKAGE System::DynamicArray<System::Byte> __fastcall StringTosgcArrayOfBytes(System::UnicodeString aString);
extern DELPHI_PACKAGE System::UnicodeString __fastcall sgcArrayOfBytesToStringWithoutNull(System::DynamicArray<System::Byte> aArray);
...
extern DELPHI_PACKAGE void __fastcall sgcAddBytes(Sgcidglobal::TIdBytes aBytesOrg, Sgcidglobal::TIdBytes &aBytesDest);
...
extern DELPHI_PACKAGE bool __fastcall IsOAuth2Header(System::Classes::TStringList* aHeaders, System::UnicodeString aAuthURL, System::UnicodeString aMethod = u"GET");
...
extern DELPHI_PACKAGE __int64 __fastcall sgcGetContentLength(Sgcidheaderlist::TIdHeaderList* const aHeaders)/* overload */;
}	/* namespace Sgcwebsocket_helpers */
