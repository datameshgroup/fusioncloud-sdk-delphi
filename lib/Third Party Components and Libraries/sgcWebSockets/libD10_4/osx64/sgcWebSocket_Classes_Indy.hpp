...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Classes_Indy.pas' rev: 34.00 (MacOS)
...
//-- type declarations -------------------------------------------------------
typedef System::DynamicArray<System::Byte> _dt_Sgcwebsocket_classes_indy_1;
typedef void __fastcall (__closure *TsgcWSHTTP2RequestEvent)(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, System::Classes::TStringList* const aHeaders, const _dt_Sgcwebsocket_classes_indy_1 Bytes, int aStreamIdentifierRequest, int aStreamIdentifierPush);
...
private:
	...
	int FPayLoadLength;
	int FPLState;
	Sgcidglobal::TIdBytes FReadBuffer;
	bool FReadMasked;
	int FState;
...
public:
	...
	__property Sgcidglobal::TIdBytes ReadBuffer = {read=FReadBuffer, write=FReadBuffer};
...
class PASCALIMPLEMENTATION TsgcWSIdLogFileServerConnection : public Sgcidserverinterceptlogbase::TIdServerInterceptLogFileConnection
{
	typedef Sgcidserverinterceptlogbase::TIdServerInterceptLogFileConnection inherited;
...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TsgcWSIdLogFileServerConnection(System::Classes::TComponent* AOwner)/* overload */ : Sgcidserverinterceptlogbase::TIdServerInterceptLogFileConnection(AOwner) { }
	
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TsgcWSIdLogFileServerConnection()/* overload */ : Sgcidserverinterceptlogbase::TIdServerInterceptLogFileConnection() { }
...
protected:
	...
	Sgcidglobal::TIdBytes __fastcall GetWSAccept(System::UnicodeString aKey1, System::UnicodeString aKey2, System::UnicodeString aKey3)/* overload */;
public:
...
class PASCALIMPLEMENTATION TsgcWSConnection_Base_Indy : public Sgcwebsocket_classes_http2::TsgcWSConnection_Base_HTTP2
{
	typedef Sgcwebsocket_classes_http2::TsgcWSConnection_Base_HTTP2 inherited;
...
public:
	virtual void __fastcall DisconnectPeer() = 0 ;
...
private:
	...
	Sgcidglobal::TIdBytes __fastcall DoEncodeMaskingKey();
	Sgcidglobal::TIdBytes __fastcall DoEncodePayLoad(__int64 aLength);
	Sgcidglobal::TIdBytes __fastcall DoEncodeMessage(Sgcidglobal::TIdBytes aBytes, Sgcidglobal::TIdBytes aBytesMsg);
	Sgcidheaderlist::TIdHeaderList* FHeadersRequest;
	Sgcidheaderlist::TIdHeaderList* __fastcall GetHeadersRequest();
	
protected:
	virtual void __fastcall DoHandshake() = 0 ;
	
public:
	__property Sgcidheaderlist::TIdHeaderList* HeadersRequest = {read=GetHeadersRequest};
...
protected:
	...
	virtual void __fastcall DoHTTPError(int aCode = 0x194, System::UnicodeString aDescription = u"Not Found") = 0 ;
...
protected:
	...
	virtual void __fastcall DoHTTPError(int aCode = 0x194, System::UnicodeString aDescription = u"Not Found");
