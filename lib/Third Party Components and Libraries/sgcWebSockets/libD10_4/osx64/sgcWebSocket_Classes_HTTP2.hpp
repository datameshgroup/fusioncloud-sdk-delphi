...
// (DO NOT EDIT: machine generated header) 'sgcWebSocket_Classes_HTTP2.pas' rev: 34.00 (MacOS)
...
//-- type declarations -------------------------------------------------------
typedef System::DynamicArray<System::Byte> _dt_Sgcwebsocket_classes_http2_1;
typedef void __fastcall (__closure *TsgcWSHTTP2RequestEvent)(Sgcwebsocket_classes::TsgcWSConnection* const aConnection, System::Classes::TStringList* const aHeaders, const _dt_Sgcwebsocket_classes_http2_1 Bytes, int aStreamIdentifierRequest, int aStreamIdentifierPush, System::Classes::TStream* const aPostStream);
...
protected:
	virtual void __fastcall OnHTTP2WriteBytesEvent(System::TObject* Sender, const System::DynamicArray<System::Byte> aBytes);
	...
	virtual void __fastcall DoHTTP2Error(int aCode = 0x194, System::UnicodeString aDescription = u"Not Found");
