object frmServerChat: TfrmServerChat
  Left = 0
  Top = 0
  Caption = 'WebSockets Server Chat'
  ClientHeight = 703
  ClientWidth = 531
  Color = clBtnFace
  ...
  object pageChat: TPageProducer
    HTMLDoc.Strings = (
      ...
      '{'
        ...
        #9'  ws = new sgcWebSocket('#39'ws<#ssl>://<#host>:<#port><#authentica' +
        'tion>'#39');'
