...
begin
  ...
  case cboOpenSSLAPI.ItemIndex of
    ...
    2: WSClient.TLSOptions.OpenSSL_Options.APIVersion := oslAPI_3_0;
  end;
...
procedure TfrmClientChat.WSClientError(Connection: TsgcWSConnection; const
    Error: string);
begin
  memoLog.Lines.Add('#error: ' + Error);
end;

procedure TfrmClientChat.WSClientException(Connection: TsgcWSConnection; E:
    Exception);
begin
