object frmServerSnapshots: TfrmServerSnapshots
  Left = 0
  Top = 0
  Caption = 'WebSockets Server Snapshots'
  ClientHeight = 411
  ClientWidth = 531
  Color = clBtnFace
  ...
  object pageSnapshots: TPageProducer
    HTMLDoc.Strings = (
      '<!DOCTYPE html>'
      '<html>'
      '<head>'
      ...
      'function wsstart()'
      '{'
      '  ws = new sgcWebSocket('#39'ws://<#host>:<#port>'#39');'
      '  ws.on('#39'open'#39', function(evt)'
      '    {'
      
        '      document.getElementById('#39'status'#39').innerHTML = "Socket Open' +
        '";'
      '      document.getElementById('#39'status'#39').className = "online";'
      '    }'
      '  );'
      ''
      '  ws.on('#39'close'#39', function(evt)'
      '    {'
      
        '      document.getElementById('#39'status'#39').innerHTML = "Socket Clos' +
        'ed";'
      '      document.getElementById('#39'status'#39').className = "offline";'
      '    }'
      '  );'#9'  '
      '  '
      '  ws.on('#39'stream'#39', function(evt)'
      '    {     '
      '      a =  URL.createObjectURL(evt.stream);'
      '      document.getElementById('#39'image'#39').src= a;'
      ''
      
        '      setTimeout(function(){ URL.revokeObjectURL(a); a = '#39#39'}, 20' +
        '0);'
      '    }'
      '  );'
      '}'
      ...
      #9'<div data-role="content">'#9
        ...
        #9'<a href="javascript:wsstart()" data-role="button" data-inline="' +
        'true">Start</a>'#9
      
        #9'<a href="javascript:wsstop()" data-role="button" data-inline="t' +
        'rue">Stop</a>'
      #9'<p id="status" classname="success"></p>'
      #9'<img src="" id="image" width="50%" height="50%">'
      #9'</div><!-- /content -->'#9
      ...
      '</body>'
      '</html>')
    OnHTMLTag = pageSnapshotsHTMLTag
    Left = 56
    Top = 48
  end
