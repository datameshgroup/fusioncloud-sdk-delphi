object frmServerRTCMultiConnection: TfrmServerRTCMultiConnection
  Left = 0
  Top = 0
  Caption = 'sgcWebSockets RTCMultiConnection Demo'
  ClientHeight = 410
  ClientWidth = 531
  Color = clBtnFace
  ...
  object pageRTCMultiConnection: TPageProducer
    HTMLDoc.Strings = (
      '<!DOCTYPE html>'
      '<html>'
      '<head>'
      ...
      ''
      '</body></html>')
    OnHTMLTag = pageRTCMultiConnectionHTMLTag
    Left = 56
    Top = 48
  end
  object RTCMultiConnection: TsgcWSAPIServer_RTCMultiConnection
    Server = WSServer
    RTCMultiConnection.HTMLDocuments.ScreenSharing = '/RTCMultiConnection-ScreenSharing.html'
    RTCMultiConnection.HTMLDocuments.VideoBroadcasting = '/RTCMultiConnection-VideoBroadcasting.html'
    RTCMultiConnection.HTMLDocuments.VideoConferencing = '/RTCMultiConnection-VideoConferencing.html'
    RTCMultiConnection.IceServers.Strings = (
      '['
      '{"urls": "stun:www.esegece.com"}, '
      '{'
      '"urls": "turn:www.esegece.com",'
      '"username": "sgc",'
      '"credential": "secret"'
      '}]')
    RTCMultiConnection.Server.Host = '127.0.0.1'
    RTCMultiConnection.Server.Port = 8443
    RTCMultiConnection.VideoResolution.FrameRate = 30
    RTCMultiConnection.VideoResolution.Height = 720
    RTCMultiConnection.VideoResolution.Width = 1280
    RTCMultiConnection.VideoResolution.Resolution = rtcvrHDReady
    Left = 88
    Top = 48
  end
end
