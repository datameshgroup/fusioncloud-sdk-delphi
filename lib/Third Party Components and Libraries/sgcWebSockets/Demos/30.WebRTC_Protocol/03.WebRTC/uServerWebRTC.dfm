object frmServerWebRTC: TfrmServerWebRTC
  Left = 0
  Top = 0
  Caption = 'WebSockets WebRTC Video'
  ClientHeight = 411
  ClientWidth = 531
  Color = clBtnFace
  ...
  object pageWebRTC: TPageProducer
    HTMLDoc.Strings = (
      '<!DOCTYPE html>'
      '<html>'
      '<head>'
      ...
      #9'<meta http-equiv="pragma" content="no-cache" />'
        ...
        'e=1">'
      #9'<title>Websockets WebRTC Video Demo</title>'
      
        #9'<script src="http://<#host>:<#port>/sgcWebSockets.js"></script>' +
        #9
      
        #9'<script src="http://<#host>:<#port>/webrtc.esegece.com.js"></sc' +
        'ript>'#9
      ...
      ''
      'function wsstart() {'
      #9#9#9'socket = new sgcws_webrtc('#39'ws://<#host>:<#port>'#39'); '
      ''
      ...
      #9#9#9#9'{  '
        ...
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li>'#39' + event.m' +
        'essage + '#39'</li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      ...
      #9#9#9#9'{  '
        ...
        'bed:'#39' + event.channel + '#39' - '#39' + event.users + '#39'</b></li>'#39' + docu' +
        'ment.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      ...
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'sgcmediastart'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'localVideo'#39').srcObject = event.str' +
        'eam;'
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcmedi' +
        'astart</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9#9
      
        #9#9#9#9#9'setTimeout(function() {socket.webrtc_connect(<#channel>);},' +
        ' 3000);'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcmediastop'#39', function(event)'
      #9#9#9#9'{  '
      #9#9#9#9#9'document.getElementById('#39'localVideo'#39').src = '#39#39';'
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcmedi' +
        'astop</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcmediaerror'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcmedi' +
        'aerror:'#39' + event.code + '#39'</b></li>'#39' + document.getElementById('#39'l' +
        'og'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcsessionconnecting'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcsess' +
        'ionconnecting</b></li>'#39' + document.getElementById('#39'log'#39').innerHT' +
        'ML;'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcsessionopen'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcsess' +
        'ionopen</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcsessionclose'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcsess' +
        'ionclose</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9#9#9#9
      #9#9#9'socket.on('#39'sgcaddstream'#39', function(event)'
      #9#9#9#9'{  '
      
        '                                                                ' +
        '                if (document.getElementById('#39'remoteVideo'#39').srcOb' +
        'ject !== event.stream) {'
      
        #9#9#9'                                  document.getElementById('#39're' +
        'moteVideo'#39').srcObject = event.stream;'
      
        '  '#9#9#9#9#9'  document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgc' +
        'addstream</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'#9
      
        '                                                                ' +
        '                }'
      #9#9#9#9'}'
      #9#9#9');'#9
      #9#9#9'socket.on('#39'sgcremovestream'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#sgcremo' +
        'vestream</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      '}'#9#9
      ''
      'function wsstop() {'
      #9#9#9'socket.webrtc_disconnect(<#channel>);'
      #9#9#9'socket.close();'
      '}'
      ''
      'function wssend()'
      '{'
      #9'if (socket.state() === "open") {'
      #9#9'if (document.getElementById('#39'chat'#39').value == "") {'
      #9#9
      #9#9'} else {'
      
        #9#9#9'socket.broadcast('#39'<b>'#39' + document.getElementById('#39'name'#39').valu' +
        'e + '#39': </b>'#39' + document.getElementById('#39'chat'#39').value, <#channel>' +
        ');     '
      ...
      '</head> '
      '<body> '
      '<div data-role="page" id="wsdemo_webrtc">'
      ''
      ...
      #9'<div data-role="content">'#9
        ...
        #9#9'<h2>Press Start, Allow use your Camera and type your name to S' +
        'end a message</h2>'
      
        #9#9#9'<a href="javascript:wsstart()" data-role="button" data-inline' +
        '="true">Start</a>'
      
        #9#9#9'<a href="javascript:wsstop()" data-role="button" data-inline=' +
        '"true">Stop</a>'#9#9#9
      #9#9#9'<form>'
      ...
      #9#9#9'</form>'#9
      #9#9#9'<table width="100%">'
      #9#9#9#9'<tr>'
      #9#9#9#9#9'<td>'
      
        #9#9#9#9#9#9'<div id="local">LocalVideo<video width="100%" height="100%' +
        '" id="localVideo" autoplay="autoplay"/></bideo>'
      #9#9#9#9#9#9'</div>'
      #9#9#9#9#9'</td>'
      #9#9#9#9#9'<td>'
      
        #9#9#9#9#9#9'<div id="remote">RemoteVideo<video width="100%" height="10' +
        '0%" id="remoteVideo" autoplay="autoplay"></video>'#9#9
      #9#9#9#9#9'</td>'
      #9#9#9#9'</tr>'
      #9#9#9'</table>'
  ...
  object WSPWebRTC: TsgcWSPServer_WebRTC
    OnConnect = WSPWebRTCConnect
    OnDisconnect = WSPWebRTCDisconnect
    OnMessage = WSPWebRTCMessage
    OnError = WSPWebRTCError
    OnSubscription = WSPWebRTCSubscription
    OnUnSubscription = WSPWebRTCUnSubscription
    Server = WSServer
    Left = 88
    Top = 48
  end
