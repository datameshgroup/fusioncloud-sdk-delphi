object frmServerWAMP: TfrmServerWAMP
  Left = 0
  Top = 0
  Caption = 'WebSockets Server WAMP'
  ClientHeight = 411
  ClientWidth = 531
  Color = clBtnFace
  ...
  object pageWAMP: TPageProducer
    HTMLDoc.Strings = (
      ...
      #9'<meta http-equiv="pragma" content="no-cache" />'
        ...
        'e=1">'
      #9'<title>Server WAMP Demo</title>'
      
        #9'<script src="http://<#host>:<#port>/sgcWebSockets.js"></script>' +
        #9
      
        #9'<script src="http://<#host>:<#port>/wamp.esegece.com.js"></scri' +
        'pt>'#9
      ...
      ''
      'function wsopen () {'
      #9#9#9'socket = new sgcws_wamp('#39'ws://<#host>:<#port>'#39'); '
      ''
      ...
      #9#9#9#9'{  '
        ...
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#messsag' +
        'e:'#39' + event.message + '#39'</b></li>'#39' + document.getElementById('#39'log' +
        #39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'wampwelcome'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#welcome' +
        ':'#39' + event.SessionId + '#39' - '#39' + event.ProtocolVersion + '#39' - '#39' + e' +
        'vent.ServerIdent + '#39'</b></li>'#39' + document.getElementById('#39'log'#39').' +
        'innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'wampcallresult'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#call re' +
        'sult:'#39' + event.CallId + '#39' - '#39' + event.CallResult + '#39'</b></li>'#39' +' +
        ' document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'wampcallprogressresult'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#call pr' +
        'ogress result:'#39' + event.CallId + '#39' - '#39' + event.CallResult + '#39'</b' +
        '></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'wampcallerror'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#call er' +
        'ror:'#39' + event.CallId + '#39' - '#39' + event.ErrorURI + '#39' - '#39' + event.Er' +
        'rorDesc + '#39' - '#39' + event.ErrorDetails  + '#39'</b></li>'#39' + document.g' +
        'etElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'wampevent'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#event:'#39 +
        ' + event.TopicURI + '#39' - '#39' + event.Event + '#39'</b></li>'#39' + document' +
      ...
      '</head> '
      '<body> '
      '<div data-role="page" id="wsdemo_wamp">'
      ''
      ...
      #9'<div data-role="content">'#9
        ...
        #9#9'<h2>Press Open, subscribe to a channel and publish messages. U' +
        'se Call Button to do a Remote Procedure Call to server.</h2>'
      #9#9#9'<p id="status"></p>'
      ...
      #9#9#9'<form>'
        ...
        #9#9#9#9'<input type="text" id="topicURI" data-mini="true" placeholde' +
        'r="channel name" value="sgc:test" />'
      
        #9#9#9#9'<a href="javascript:socket.subscribe(document.getElementById' +
        '('#39'topicURI'#39').value)" data-role="button" data-inline="true">Subsc' +
        'ribe</a>'
      
        #9#9#9#9'<a href="javascript:socket.unsubscribe(document.getElementBy' +
        'Id('#39'topicURI'#39').value)" data-role="button" data-inline="true">UnS' +
        'ubscribe</a>'
      #9#9#9'</form>'#9
      #9#9#9'<form>'
      
        #9#9#9#9'<input type="text" id="Key" data-mini="true" placeholder="Pr' +
        'efix Key Name" value="sgc" />'
      
        #9#9#9#9'<input type="text" id="Value" data-mini="true" placeholder="' +
        'Prefix Value Name" value="http://www.esegece.com" />'
      
        #9#9#9#9'<a href="javascript:socket.prefix(document.getElementById('#39'K' +
        'ey'#39').value, document.getElementById('#39'Value'#39').value)" data-role="' +
        'button" data-inline="true">Prefix</a>'
      #9#9#9'</form>'#9
      #9#9#9'<form>'
      
        #9#9#9#9'<input type="text" id="CallId" data-mini="true" placeholder=' +
        '"UUID" value="LAKSPWAE2123JA" />'
      
        #9#9#9#9'<input type="text" id="ProcURI" data-mini="true" placeholder' +
        '="Procedure URI" value="sgc:calculate" />'
      
        #9#9#9#9'<input type="text" id="Arguments" data-mini="true" placehold' +
        'er="RPC Arguments" value=20 />'
      
        #9#9#9#9'<a href="javascript:socket.call(document.getElementById('#39'Cal' +
        'lId'#39').value, document.getElementById('#39'ProcURI'#39').value, document.' +
        'getElementById('#39'Arguments'#39').value)" data-role="button" data-inli' +
        'ne="true">Call</a>'
      #9#9#9'</form>'#9
      #9#9#9'<form>'
      
        #9#9#9#9'<input type="text" id="ProgressCallId" data-mini="true" plac' +
        'eholder="UUID" value="SKDJ33LS93KSJ3AZ" />'
      
        #9#9#9#9'<input type="text" id="ProgressProcURI" data-mini="true" pla' +
        'ceholder="Procedure URI" value="sgc:timer" />'
      
        #9#9#9#9'<input type="text" id="ProgressArguments" data-mini="true" p' +
        'laceholder="RPC Arguments" value=20 />'
      
        #9#9#9#9'<a href="javascript:socket.call(document.getElementById('#39'Pro' +
        'gressCallId'#39').value, document.getElementById('#39'ProgressProcURI'#39').' +
        'value, document.getElementById('#39'ProgressArguments'#39').value)" data' +
        '-role="button" data-inline="true">Progress Call</a>'
      
        #9#9#9#9'<a href="javascript:socket.cancelcall(document.getElementByI' +
        'd('#39'ProgressCallId'#39').value)" data-role="button" data-inline="true' +
        '">Cancel Call</a>'
      #9#9#9'</form>'#9
      #9#9#9'<form>'
      
        #9#9#9#9'<input type="text" id="Topic" data-mini="true" placeholder="' +
        'Topic" value="sgc:test" />'
      
        #9#9#9#9'<input type="text" id="Event" data-mini="true" placeholder="' +
        'Event Message" value="Hello World!" />'
      
        #9#9#9#9'<a href="javascript:socket.publish(document.getElementById('#39 +
        'Topic'#39').value, document.getElementById('#39'Event'#39').value)" data-rol' +
        'e="button" data-inline="true">Publish</a>'
      #9#9#9'</form>'#9#9
      ...
      #9#9#9'<p>&copy; 2021 eSeGeCe.com</p>'
      #9'</div>'#9#9
      '</div><!-- /page -->'
      ''
      '</body>'
      '</html>')
    OnHTMLTag = pageWAMPHTMLTag
    Left = 88
    Top = 48
  end
  ...
  object WSPWAMP: TsgcWSPServer_WAMP
    OnConnect = WSPWAMPConnect
    OnDisconnect = WSPWAMPDisconnect
    OnMessage = WSPWAMPMessage
    OnError = WSPWAMPError
    OnSubscription = WSPWAMPSubscription
    OnUnSubscription = WSPWAMPUnSubscription
    OnCall = WSPWAMPCall
    OnBeforeCancelCall = WSPWAMPBeforeCancelCall
    OnPrefix = WSPWAMPPrefix
    Server = WSServer
    Left = 56
    Top = 48
  end
