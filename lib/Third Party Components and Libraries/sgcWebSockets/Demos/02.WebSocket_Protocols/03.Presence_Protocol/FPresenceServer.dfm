object Form16: TForm16
  ...
  object Presence: TsgcWSPServer_Presence
    OnNewMember = PresenceNewMember
    OnRemoveMember = PresenceRemoveMember
  ...
  object pagePresence: TPageProducer
    HTMLDoc.Strings = (
      '<!DOCTYPE html>'
      '<html>'
      '<head>'
      ...
      #9'<meta http-equiv="pragma" content="no-cache" />'
        ...
        'e=1">'
      #9'<title>Server SGC Presence Demo</title>'
      
        #9'<script src="http://<#host>:<#port>/sgcWebSockets.js"></script>' +
        #9
      
        #9'<script src="http://<#host>:<#port>/presence.esegece.com.js"></' +
        'script>'#9
      ...
      ''
      'function wsopen () {'
      #9#9#9'socket = new sgcws_presence('#39'ws://<#host>:<#port>'#39'); '
      ''
      ...
      #9#9#9#9'{   '
        ...
        #9#9#9#9#9'socket.newmember(event.id, document.getElementById('#39'member_' +
        'name'#39').value, '#39#39');'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'sgcnewmember'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#new mem' +
        'ber: '#39' + event.member.name + '#39'</b></li>'#39' + document.getElementBy' +
        'Id('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9#9#9
      #9#9#9'socket.on('#39'sgcremovemember'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#remove ' +
        'member: '#39' + event.member.name + '#39'</b></li>'#39' + document.getElemen' +
        'tById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'sgcnewchannelmember'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#new mem' +
        'ber: '#39' + event.member.name + '#39' in channel: '#39' + event.channel.nam' +
        'e + '#39'</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      #9#9#9'socket.on('#39'sgcremovechannelmember'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#remove ' +
        'member: '#39' + event.member.name + '#39' from channel: '#39' + event.channe' +
        'l.name + '#39'</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9#9#9
      #9#9#9'socket.on('#39'sgcpublishmsg'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#publish' +
        'msg: '#39' + event.message.text + '#39'</b></li>'#39' + document.getElementB' +
        'yId('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9#9#9
      #9#9#9'socket.on('#39'sgcgetmembers'#39', function(event)'
      #9#9#9#9'{  '
      #9#9#9#9#9'for (var i  in event.members) {'
      
        #9#9#9#9#9'  document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#get m' +
        'embers: '#39' + event.members[i].id + '#39' '#39' + event.members[i].name + ' +
        ' '#39'</b></li>'#39' + document.getElementById('#39'log'#39').innerHTML;'
      #9#9#9#9#9'}'
      #9#9#9#9'}'
      #9#9#9');'#9#9
      #9#9#9'socket.on('#39'sgcerrormemberchannel'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#error m' +
        'ember channel: '#39' + event.error.text + '#39'</b></li>'#39' + document.get' +
        'ElementById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'#9#9#9
      #9#9#9'socket.on('#39'sgcerrorpublishmsg'#39', function(event)'
      #9#9#9#9'{  '
      
        #9#9#9#9#9'document.getElementById('#39'log'#39').innerHTML = '#39'<li><b>#error p' +
        'ublish: '#39' + event.error.text + '#39'</b></li>'#39' + document.getElement' +
        'ById('#39'log'#39').innerHTML;'
      #9#9#9#9'}'
      #9#9#9');'
      '}'#9
      ''
      ...
      'function generateName(){'
        ...
        #9'var name1 = ["OLIVER","JACK","HARRY","JACOB","CHARLIE","THOMAS"' +
        ',"OSCAR","WILLIAM","JAMES","GEORGE","ALFIE","JOSHUA","NOAH","ETH' +
        'AN","MUHAMMAD","ARCHIE","LEO","HENRY","JOSEPH","SAMUEL"];'
      ''
      #9'var name = capFirst(name1[getRandomInt(0, name1.length + 1)]);'
      #9'document.getElementById('#39'member_name'#39').value = name;'
      '}'
      '</script>'
      ''
      '</head> '
      '<body> '
      '<div data-role="page" id="wsdemo_presence">'
      ''
      #9'<div data-role="header" data-theme="b">'#9
      #9#9'<h1>Presence Protocol Sample</h1>'
      ...
      #9#9#9'<form>'
        ...
        #9#9#9#9'<input type="text" id="member_name" data-mini="true" placeho' +
        'lder="member name" value="" />'
      #9#9#9'</form>'#9
      
        #9#9#9'<a href="javascript:generateName(); wsopen();" data-role="but' +
        'ton" data-inline="true">Open</a>'
      ...
      #9#9#9'<form>'
        ...
        'Topic 1 Subscribed Clients'
      #9#9#9'</form>'#9
      #9#9#9'<form>'
      
        #9#9#9#9'<a href="javascript:socket.getmembers()" data-role="button" ' +
        'data-inline="true">Get Members</a> Get a list of all members con' +
        'nected.'
      #9#9#9'</form>'#9
      '                                            </td>'
      '                                            <td valign="top">'
